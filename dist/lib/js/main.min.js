!function (t) {
	...
	function e(t) {
		return function () {
			var e,
			n = arguments[0];
			for (e = "[" + (t ? t + ":" : "") + n + "] http://errors.angularjs.org/1.5.8/" + (t ? t + "/" : "") + n, n = 1; n < arguments.length; n++) {
				e = e + (1 == n ? "?" : "&") + "p" + (n - 1) + "=";
				var r,
				i = encodeURIComponent;
				r = arguments[n],
				r = "function" == typeof r ? r.toString().replace(/ \{[\s\S]*$/, "") : "undefined" == typeof r ? "undefined" : "string" != typeof r ? JSON.stringify(r) : r,
				e += i(r)
			}
			return Error(e)
		}
	...
	function n(t) {
		if (null == t || E(t))
			return !1;
		if (ar(t) || b(t) || zn && t instanceof zn)
			return !0;
	...
	function r(t, e, i) {
		...
		if (t)
			if (S(t))
				for (o in t)
					"prototype" == o || "length" == o || "name" == o || t.hasOwnProperty && !t.hasOwnProperty(o) || e.call(i, t[o], o, t);
			else if (ar(t) || n(t)) {
				var s = "object" != typeof t;
				for (o = 0, a = t.length; o < a; o++)
					(s || o in t) && e.call(i, t[o], o, t)
			} else if (t.forEach && t.forEach !== r)
				t.forEach(e, i, t);
			else if (y(t))
				for (o in t)
					e.call(i, t[o], o, t);
		...
		for (var r = t.$$hashKey, i = 0, o = e.length; i < o; ++i) {
			...
			if (g(a) || S(a))
				for (var u = Object.keys(a), c = 0, l = u.length; c < l; c++) {
					var f = u[c],
					h = a[f];
					n && g(h) ? x(h) ? t[f] = new Date(h.valueOf()) : C(h) ? t[f] = new RegExp(h) : h.nodeName ? t[f] = h.cloneNode(!0) : M(h) ? t[f] = h.clone() : (g(t[f]) || (t[f] = ar(h) ? [] : {}), s(t[f], [h], !0)) : t[f] = h
				}
		}
		return r ? t.$$hashKey = r : delete t.$$hashKey,
		t
	}
	function u(t) {
		return s(t, Xn.call(arguments, 1), !1)
	}
	function c(t) {
		return s(t, Xn.call(arguments, 1), !0)
	}
	function l(t) {
	...
	function $(t) {
		return S(t.toString) && t.toString !== er
	}
	function m(t) {
	...
	function O(t) {
		return t && w(t.length) && sr.test(er.call(t))
	}
	function M(t) {
	...
	function j(t, e) {
		function n(t, e) {
			...
			if (ar(t)) {
				...
				for (n in t)
					t.hasOwnProperty(n) && (e[n] = i(t[n]));
			else
				for (n in t)
					Jn.call(t, n) && (e[n] = i(t[n]));
			return r ? e.$$hashKey = r : delete e.$$hashKey,
			e
		}
		function i(t) {
			if (!g(t))
			...
			var e = !1,
			r = o(t);
			return void 0 === r && (r = ar(t) ? [] : Object.create(nr(t)), e = !0),
			a.push(t),
			s.push(r),
			e ? n(t, r) : r
		}
		function o(t) {
			...
			case "[object RegExp]":
				return e = new RegExp(t.source, t.toString().match(/[^\/]*$/)[0]),
		...
		s = [];
		if (e) {
			if (O(e) || "[object ArrayBuffer]" === er.call(e))
				throw rr("cpta");
			if (t === e)
				throw rr("cpi");
			return ar(e) ? e.length = 0 : r(e, function (t, n) {
	...
	function I(t, e) {
		...
		if (r == typeof e && "object" == r) {
			if (!ar(t)) {
				if (x(t))
					return !!x(e) && I(t.getTime(), e.getTime());
				if (C(t))
					return !!C(e) && t.toString() == e.toString();
				if (k(t) || k(e) || E(t) || E(e) || ar(e) || x(e) || C(e))
					return !1;
				r = at();
				for (n in t)
					if ("$" !== n.charAt(0) && !S(t[n])) {
				...
				for (n in e)
					if (!(n in r) && "$" !== n.charAt(0) && v(e[n]) && !S(e[n]))
						return !1;
				return !0
			}
			if (!ar(e))
	...
	function R(e, n) {
		var r = n;
		return "string" == typeof e && "$" === e.charAt(0) && "$" === e.charAt(1) ? r = void 0 : E(n) ? r = "$WINDOW" : n && t.document === n ? r = "$DOCUMENT" : k(n) && (r = "$SCOPE"),
		r
	}
	function F(t, e) {
		if (!m(t))
			return w(e) || (e = e ? 2 : null), JSON.stringify(t, R, e)
	}
	function U(t) {
	...
	function L(t) {
		...
		try {
			return t[0].nodeType === mr ? Kn(n) : n.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/, function (t, e) {
				return "<" + Kn(e)
			})
		} catch (r) {
			return Kn(n)
	...
	function H(t) {
		...
		return r((t || "").split("&"), function (t) {
			...
			r,
			i;
			t && (r = t = t.replace(/\+/g, "%20"), n = t.indexOf("="), -1 !== n && (r = t.substring(0, n), i = t.substring(n + 1)), r = B(r), v(r) && (i = !v(i) || B(i), Jn.call(e, r) ? ar(e[r]) ? e[r].push(i) : e[r] = [e[r], i] : e[r] = i))
		}),
		e
	}
	function z(t) {
	...
	function Z(t, e) {
		...
		i = pr.length;
		for (r = 0; r < i; ++r)
			if (n = pr[r] + e, b(n = t.getAttribute(n)))
				return n;
		return null
	}
	function J(t, e) {
		...
		r(pr, function (e) {
			e += "app",
			!n && t.hasAttribute && t.hasAttribute(e) && (n = t, i = t.getAttribute(e))
		}),
		r(pr, function (e) {
			e += "app";
			var r;
		...
		n && (o.strictDi = null !== Z(n, "strict-di"), e(n, i ? [i] : [], o))
	}
	function K(e, n, i) {
		g(i) || (i = {}),
		i = u({
		...
		var o = function () {
			if (e = zn(e), e.injector()) {
				...
				throw rr("btstrpd", r.replace(/</, "&lt;").replace(/>/, "&gt;"))
			}
			return n = n || [],
			...
			n.unshift("ng"),
			r = Ut(n, i.strictDi),
			r.invoke(["$rootScope", "$rootElement", "$compile", "$injector", function (t, e, n, r) {
						t.$apply(function () {
							e.data("$injector", r),
							n(e)(t)
						})
		...
		return t && a.test(t.name) && (i.debugInfoEnabled = !0, t.name = t.name.replace(a, "")),
		t && !s.test(t.name) ? o() : (t.name = t.name.replace(s, ""), ir.resumeBootstrap = function (t) {
			return r(t, function (t) {
				n.push(t)
			}),
			o()
		}, void(S(ir.resumeDeferredBootstrap) && ir.resumeDeferredBootstrap()))
	}
	function Y() {
	...
	function X(t) {
		if (t = ir.element(t).injector(), !t)
			throw rr("test");
		return t.get("$$testability")
	}
	function Q(t, e) {
		return e = e || "_",
		t.replace(dr, function (t, n) {
	...
	function tt() {
		...
		if (!$r) {
			var n = fr();
			(Wn = m(n) ? t.jQuery : n ? t[n] : void 0) && Wn.fn.on ? (zn = Wn, u(Wn.fn, {
					scope : Nr.scope,
					isolateScope : Nr.isolateScope,
					controller : Nr.controller,
					injector : Nr.injector,
					inheritedData : Nr.inheritedData
				}), e = Wn.cleanData, Wn.cleanData = function (t) {
				for (var n, r, i = 0; null != (r = t[i]); i++)
					(n = Wn._data(r, "events")) && n.$destroy && Wn(r).triggerHandler("$destroy");
				e(t)
			}) : zn = dt,
			ir.element = zn,
			$r = !0
	...
	function nt(t, e, n) {
		return n && ar(t) && (t = t[t.length - 1]),
		et(S(t), e, "not a function, got " + (t && "object" == typeof t ? t.constructor.name || "Object" : typeof t)),
		t
	}
	function rt(t, e) {
		if ("hasOwnProperty" === t)
	...
	function ot(t) {
		for (var e, n = t[0], r = t[t.length - 1], i = 1; n !== r && (n = n.nextSibling); i++)
			(e || t[i] !== n) && (e || (e = zn(Xn.call(t, 0, i))), e.push(n));
		return e || t
	}
	function at() {
	...
	function st(t) {
		...
		n(t, "module", function () {
			...
			return function (e, o, a) {
				...
				return o && t.hasOwnProperty(e) && (t[e] = null),
				n(t, e, function () {
					function t(t, e, n, r) {
						return r || (r = i),
						function () {
							return r[n || "push"]([t, e, arguments]),
							l
						}
					}
					function n(t, n) {
						return function (r, o) {
							return o && S(o) && (o.$$moduleName = e),
							i.push([t, n, arguments]),
							l
						}
					}
					if (!o)
	...
	function ct(n) {
		...
		(Gn = st(t))("ng", ["ngLocale"], ["$provide", function (t) {
					t.provider({
						$$sanitizeUri : Ye
					}),
	...
	function lt(t) {
		return t.replace(br, function (t, e, n, r) {
	...
	function ht(t, e) {
		...
		a = [];
		if (Er.test(t)) {
			for (n = o.appendChild(e.createElement("div")), i = (kr.exec(t) || ["", ""])[1].toLowerCase(), i = Or[i] || Or._default, n.innerHTML = i[1] + t.replace(Ar, "<$1></$2>") + i[2], i = i[0]; i--; )
				n = n.lastChild;
			a = D(a, n.childNodes),
			n = o.firstChild,
			n.textContent = ""
	...
	function dt(e) {
		if (e instanceof dt)
			return e;
		var n;
		if (b(e) && (e = ur(e), n = !0), !(this instanceof dt)) {
			if (n && "<" != e.charAt(0))
				throw Sr("nosel");
			return new dt(e)
		}
		if (n) {
			n = t.document;
			var r;
			e = (r = Cr.exec(e)) ? [n.createElement(r[1])] : (r = ht(e, n)) ? r.childNodes : []
		}
		Ct(this, e)
	}
	function $t(t) {
		...
		if (a)
			if (e) {
				var s = function (e) {
					var r = o[e];
					v(n) && V(r || [], n),
					v(n) && r && 0 < r.length || (t.removeEventListener(e, a, !1), delete o[e])
				};
				...
				for (e in o)
					"$destroy" !== e && t.removeEventListener(e, a, !1), delete o[e]
	}
	function gt(t, e) {
		var n = t.ng339,
		r = n && gr[n];
		r && (e ? delete r.data[e] : (r.handle && (r.events.$destroy && r.handle({}, "$destroy"), vt(t)), delete gr[n], t.ng339 = void 0))
	}
	function yt(t, e) {
		var n = t.ng339,
		n = n && gr[n];
		return e && !n && (t.ng339 = n = ++yr, n = gr[n] = {
				events : {},
				data : {},
				handle : void 0
			}),
	...
	function xt(t, e) {
		e && t.setAttribute && r(e.split(" "), function (e) {
			t.setAttribute("class", ur((" " + (t.getAttribute("class") || "") + " ").replace(/[\n\t]/g, " ").replace(" " + ur(e) + " ", " ")))
		})
	}
	function St(t, e) {
		if (e && t.setAttribute) {
	...
	function kt(t, e, n) {
		for (9 == t.nodeType && (t = t.documentElement), e = ar(e) ? e : [e]; t; ) {
			for (var r = 0, i = e.length; r < i; r++)
				if (v(n = zn.data(t, e[r])))
					return n;
			t = t.parentNode || 11 === t.nodeType && t.host
		}
	}
	function At(t) {
		for (mt(t, !0); t.firstChild; )
	...
	function Mt(e, n) {
		n = n || t,
		"complete" === n.document.readyState ? n.setTimeout(e) : zn(n).on("load", e)
	}
	function Nt(t, e) {
	...
	function Tt(t, e) {
		var n = function (n, r) {
			...
			if (o) {
				...
				var s = i.specialHandlerWrapper || Vt;
				1 < o && (i = ut(i));
				for (var u = 0; u < o; u++)
	...
	function Rt(t) {
		return t = (Function.prototype.toString.call(t) + " ").replace(Ur, ""),
		t.match(Dr) || t.match(Pr)
	}
	function Ft(t) {
	...
	function Ut(t, e) {
		...
		function i(t, e) {
			if (rt(t, "service"), (S(e) || ar(e)) && (e = $.instantiate(e)), !e.$get)
				throw _r("pget", t);
		...
		function u(t) {
			et(m(t) || ar(t), "modulesToLoad", "not an array");
			var e,
			n = [];
			return r(t, function (t) {
				function r(t) {
				...
				if (!h.get(t)) {
					h.put(t, !0);
					try {
						b(t) ? (e = Gn(t), n = n.concat(u(e.requires)).concat(e._runBlocks), r(e._invokeQueue), r(e._configBlocks)) : S(t) ? n.push($.invoke(t)) : ar(t) ? n.push($.invoke(t)) : nt(t, "module")
					} catch (i) {
						throw ar(t) && (t = t[t.length - 1]),
						i.message && i.stack && -1 == i.stack.indexOf(i.message) && (i = i.message + "\n" + i.stack),
						_r("modulerr", t, i.stack || i.message || i)
					}
				}
			}),
			n
		...
		function c(t, n) {
			...
			return {
				invoke : function (t, e, n, r) {
					return "string" == typeof n && (r = n, n = null),
					n = i(t, n, r),
					ar(t) && (t = t[t.length - 1]),
					r = !(11 >= Hn) && ("function" == typeof t && /^(?:class\b|constructor\()/.test(Function.prototype.toString.call(t) + " ")),
					r ? (n.unshift(null), new(Function.prototype.bind.apply(t, n))) : t.apply(e, n)
				},
				instantiate : function (t, e, n) {
					var r = ar(t) ? t[t.length - 1] : t;
					return t = i(t, e, n),
					t.unshift(null),
					new(Function.prototype.bind.apply(r, t))
				},
				get : r,
		...
		this.$get = ["$window", "$location", "$rootScope", function (e, n, r) {
				...
				function o(t) {
					if (t) {
						...
						var n;
						n = a.yOffset,
						S(n) ? n = n() : M(n) ? (n = n[0], n = "fixed" !== e.getComputedStyle(n).position ? 0 : n.getBoundingClientRect().bottom) : w(n) || (n = 0),
	...
	function Ht(t, e, n, i) {
		...
		s(),
		b = y,
		c.url = function (e, n, r) {
			if (m(r) && (r = null), l !== t.location && (l = t.location), f !== t.history && (f = t.history), e) {
				var o = b === r;
				if (w === e && (!i.history || o))
					return c;
				var a = w && be(w) === be(e);
				return w = e,
				b = r,
				!i.history || a && o ? (a || (S = e), n ? l.replace(e) : a ? (n = l, r = e.indexOf("#"), r = -1 === r ? "" : e.substr(r), n.hash = r) : l.href = e, l.href !== e && (S = e)) : (f[n ? "replaceState" : "pushState"](r, "", e), s(), b = y),
				S && (S = e),
				c
			}
		...
		c.onUrlChange = function (e) {
			return k || (i.history && zn(t).on("popstate", a), zn(t).on("hashchange", a), k = !0),
			E.push(e),
			e
		},
	...
	function Zt(e, n) {
		function i(t, e, n) {
			...
			return r(t, function (t, r) {
				if (t in C)
					...
					var a = t.match(i);
					if (!a)
						throw Zr("iscp", e, r, t, n ? "controller bindings definition" : "isolate scope definition");
					o[r] = {
						mode : a[1][0],
						collection : "*" === a[2],
						optional : "?" === a[3],
		...
		function s(t) {
			...
			return !ar(e) && g(e) && r(e, function (t, n) {
				var r = t.match(w);
		...
		l = /^\s*directive\:\s*([\w\-]+)\s+(.*)$/,
		$ = /(([\w\-]+)(?:\:([^;]+))?;?)/,
		y = N("ngSrc,ngSrcset,src,srcset"),
		w = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/,
		x = /^(on[a-z]+|formaction)$/,
		C = at();
		this.directive = function M(t, n) {
			return rt(t, "directive"),
			b(t) ? (a(t), et(n, "directiveFactory"), c.hasOwnProperty(t) || (c[t] = [], e.factory(t + "Directive", ["$injector", "$exceptionHandler", function (e, n) {
								var i = [];
								return r(c[t], function (r, o) {
									try {
										...
										S(a) ? a = {
										 ...
										 : !a.compile && a.link && (a.compile = d(a.link)),
		...
		this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (e, n, o, a, s, d, C, M, N, j) {
				function D() {
					try {
						if (!--wt)
							throw gt = void 0, Zr("infchng", O);
						C.$apply(function () {
							for (var t = [], e = 0, n = gt.length; e < n; ++e)
								try {
									gt[e]()
								} catch (r) {
									t.push(r)
								}
							if (gt = void 0, t.length)
								throw t
						})
					}
					finally {
				...
				function _(e, n, r, i, o) {
					...
					for (var a = /\S+/, s = 0, u = e.length; s < u; s++) {
						var c = e[s];
						c.nodeType === mr && c.nodeValue.match(a) && pt(c, e[s] = t.document.createElement("span"))
					}
					var l = q(e, n, e, r, i, o);
					_.$$addScopeClass(e);
					var f = null;
					return function (t, n, r) {
						...
						if (r = r.futureParentElement, i && i.$$boundTransclude && (i = i.$$boundTransclude), f || (f = (r = r && r[0]) && "foreignobject" !== T(r) && er.call(r).match(/SVG/) ? "svg" : "html"), r = "html" !== f ? zn(ct(f, zn("<div>").append(e).html())) : n ? Nr.clone.call(e) : e, a)
							for (var s in a)
								r.data("$" + s + "Controller", a[s].instance);
						return _.$$addScopeInfo(r, t),
						n && n(r, t),
						l && l(t, r, r, i),
						r
					}
				...
				function q(t, e, n, r, i, o) {
					function a(t, n, r, i) {
						...
						for (u = 0, c = h.length; u < c; )
							a = p[h[u++]], n = h[u++], o = h[u++], n ? (n.scope ? (s = t.$new(), _.$$addScopeInfo(zn(a), s)) : s = t, l = n.transcludeOnThisElement ? B(t, n.transclude, i) : !n.templateOnThisElement && i ? i : !i && e ? B(t, e) : null, n(o, s, a, r, l)) : o && o(t, a.childNodes, void 0, i)
					}
					for (var s, u, c, l, f, h = [], p = 0; p < t.length; p++)
						s = new R, u = H(t[p], [], s, 0 === p ? r : void 0, i), (o = u.length ? J(u, t[p], s, e, n, null, [], [], o) : null) && o.scope && _.$$addScopeClass(s.$$element), s = o && o.terminal || !(c = t[p].childNodes) || !c.length ? null : q(c, o ? (o.transcludeOnThisElement || !o.templateOnThisElement) && o.transclude : e), (o || s) && (h.push(p, o, s), l = !0, f = f || o), o = null;
					return l ? a : null
				}
				function B(t, e, n) {
					...
					o = r.$$slots = at();
					for (i in e.$$slots)
						o[i] = e.$$slots[i] ? B(t, e.$$slots[i], n) : null;
					return r
				}
				function H(t, e, n, r, i) {
					...
					case 1:
						tt(e, Kt(T(t)), "E", r, i);
						for (var a, s, u, c, l = t.attributes, f = 0, h = l && l.length; f < h; f++) {
							var p = !1,
							d = !1;
							a = l[f],
							s = a.name,
							u = ur(a.value),
							a = Kt(s),
							(c = Et.test(a)) && (s = s.replace(Kr, "").substr(8).replace(/_(.)/g, function (t, e) {
										return e.toUpperCase()
									})),
							(a = a.match(kt)) && nt(a[1]) && (p = s, d = s.substr(0, s.length - 5) + "end", s = s.substr(0, s.length - 6)),
							a = Kt(s.toLowerCase()),
							o[a] = s,
							!c && n.hasOwnProperty(a) || (n[a] = u, Nt(t, a) && (n[a] = !0)),
							ft(t, e, u, a, c),
							tt(e, a, "A", r, i, p, d)
						}
						if (o = t.className, g(o) && (o = o.animVal), b(o) && "" !== o)
							for (; t = $.exec(o); )
								a = Kt(t[2]), tt(e, a, "C", r, i) && (n[a] = ur(t[3])), o = o.substr(t.index + t[0].length);
						break;
					case mr:
						if (11 === Hn)
							for (; t.parentNode && t.nextSibling && t.nextSibling.nodeType === mr; )
								t.nodeValue += t.nextSibling.nodeValue, t.parentNode.removeChild(t.nextSibling);
						ut(e, t.nodeValue);
						break;
					case 8:
						z(t, e, n, r, i)
				...
				function Z(t, e, n, r, i, o) {
					var a;
					return t ? _(e, n, r, i, o) : function () {
						return a || (a = _(e, n, r, i, o), e = n = o = null),
						a.apply(this, arguments)
					}
				}
				function J(t, e, n, i, a, s, c, l, f) {
					function h(t, e, n, r) {
						t && (n && (t = G(t, n, r)), t.require = d.require, t.directiveName = $, (E === d || d.$$isolateScope) && (t = dt(t, {
										isolateScope : !0
									})), c.push(t)),
						e && (n && (e = G(e, n, r)), e.require = d.require, e.directiveName = $, (E === d || d.$$isolateScope) && (e = dt(e, {
										isolateScope : !0
									})), l.push(e))
					}
					function p(t, i, a, s, f) {
						function h(t, e, n, r) {
							var i;
							if (k(t) || (r = n, n = e, e = t, t = void 0), V && (i = b), n || (n = V ? O.parent() : O), !r)
								return f(t, e, i, n, T);
							var o = f.$$slots[r];
							if (o)
								return o(t, e, i, n, T);
							if (m(o))
								throw Zr("noslot", r, L(O))
						}
						var p,
						d,
						$,
						...
						w,
						O;
						e === a ? (s = n, O = n.$$element) : (O = zn(a), s = new R(O, n)),
						y = i,
						E ? v = i.$new(!0) : x && (y = i.$parent),
						f && (w = h, w.$$boundTransclude = f, w.isSlotFilled = function (t) {
							return !!f.$$slots[t]
						}),
						C && (b = Y(O, s, w, C, v, i, E)),
						E && (_.$$addScopeInfo(O, v, !0, !(A && (A === E || A === E.$$originalDirective))), _.$$addScopeClass(O, !0), v.$$isolateBindings = E.$$isolateBindings, d = vt(i, s, v, v.$$isolateBindings, E), d.removeWatches && v.$on("$destroy", d.removeWatches));
						for (p in b) {
							d = C[p],
							$ = b[p];
							var M = d.$$bindings.bindToController;
							$.bindingInfo = $.identifier && M ? vt(y, s, $.instance, M, d) : {};
							var N = $();
							N !== $.instance && ($.instance = N, O.data("$" + d.name + "Controller", N), $.bindingInfo.removeWatches && $.bindingInfo.removeWatches(), $.bindingInfo = vt(y, s, $.instance, M, d))
						}
						for (r(C, function (t, e) {
								var n = t.require;
								t.bindToController && !ar(n) && g(n) && u(b[e].instance, K(e, n, O, b))
							}), r(b, function (t) {
								var e = t.instance;
								if (S(e.$onChanges))
									try {
								...
								S(e.$onDestroy) && y.$on("$destroy", function () {
									e.$onDestroy()
								})
							}), p = 0, d = c.length; p < d; p++)
							$ = c[p], mt($, $.isolateScope ? v : i, O, s, $.require && K($.directiveName, $.require, O, b), w);
						var T = i;
						for (E && (E.template || null === E.templateUrl) && (T = v), t && t(T, a.childNodes, void 0, f), p = l.length - 1; 0 <= p; p--)
							$ = l[p], mt($, $.isolateScope ? v : i, O, s, $.require && K($.directiveName, $.require, O, b), w);
						r(b, function (t) {
							t = t.instance,
					...
					f = f || {};
					for (var d, $, v, y, b, w = -Number.MAX_VALUE, x = f.newScopeDirective, C = f.controllerDirectives, E = f.newIsolateScopeDirective, A = f.templateDirective, O = f.nonTlbTranscludeDirective, M = !1, N = !1, V = f.hasElementTranscludeDirective, j = n.$$element = zn(e), I = i, D = !1, F = !1, U = 0, q = t.length; U < q; U++) {
						d = t[U];
						var B = d.$$start,
						z = d.$$end;
						if (B && (j = W(e, B, z)), v = void 0, w > d.priority)
							break;
						if ((b = d.scope) && (d.templateUrl || (g(b) ? (st("new/isolated scope", E || x, d, j), E = d) : st("new/isolated scope", E, d, j)), x = x || d), $ = d.name, !D && (d.replace && (d.templateUrl || d.template) || d.transclude && !d.$$tlb)) {
							for (b = U + 1; D = t[b++]; )
						...
						if (!d.templateUrl && d.controller && (b = d.controller, C = C || at(), st("'" + $ + "' controller", C[$], d, j), C[$] = d), b = d.transclude)
							if (M = !0, d.$$tlb || (st("transclusion", O, d, j), O = d), "element" == b)
								V = !0, w = d.priority, v = j, j = n.$$element = zn(_.$$createComment($, n[$])), e = j[0], ht(a, Xn.call(v, 0), e), v[0].$$parentNode = v[0].parentNode,
								I = Z(F, v, i, w, s && s.name, {
										nonTlbTranscludeDirective : O
									});
							else {
								var J = at();
								if (v = zn($t(e)).contents(), g(b)) {
									v = [];
									var Q = at(),
									tt = at();
									r(b, function (t, e) {
									...
									r(j.contents(), function (t) {
										var e = Q[Kt(T(t))];
										e ? (tt[e] = !0, J[e] = J[e] || [], J[e].push(t)) : v.push(t)
									}),
									r(tt, function (t, e) {
										if (!t)
											throw Zr("reqslot", e)
									...
									for (var et in J)
										J[et] && (J[et] = Z(F, J[et], i))
								}
								j.empty(),
								I = Z(F, v, i, void 0, void 0, {
										needsNewScope : d.$$isolateScope || d.$$newScope
									}),
								I.$$slots = J
							}
						if (d.template)
							if (N = !0, st("template", A, d, j), A = d, b = S(d.template) ? d.template(j, n) : d.template, b = Ct(b), d.replace) {
								if (s = d, v = Er.test(b) ? Xt(ct(d.templateNamespace, ur(b))) : [], e = v[0], 1 != v.length || 1 !== e.nodeType)
									throw Zr("tplrt", $, "");
								ht(a, j, e),
								q = {
									$attr : {}
								...
								b = H(e, [], q);
								var nt = t.splice(U + 1, t.length - (U + 1));
								(E || x) && X(b, E, x),
								t = t.concat(b).concat(nt),
								rt(n, q),
								q = t.length
							} else
								j.html(b);
						if (d.templateUrl)
							N = !0, st("template", A, d, j), A = d, d.replace && (s = d), p = it(t.splice(U, t.length - U), j, n, a, M && I, c, l, {
							...
							try {
								y = d.compile(j, n, I);
								var ot = d.$$originalDirective || d;
								S(y) ? h(null, P(ot, y), B, z) : y && h(P(ot, y.pre), P(ot, y.post), B, z)
							} catch (ut) {
								o(ut, L(j))
							}
						d.terminal && (p.terminal = !0, w = Math.max(w, d.priority))
					}
					return p.scope = x && !0 === x.scope,
					p.transcludeOnThisElement = M,
					p.templateOnThisElement = N,
					p.transclude = I,
					f.hasElementTranscludeDirective = V,
					p
				}
				function K(t, e, n, i) {
					var o;
				...
				function Y(t, e, n, r, i, o, a) {
					...
					for (s in r) {
						...
						f = c.controller;
						"@" == f && (f = e[c.name]),
						l = d(f, l, !0, c.controllerAs),
						u[c.name] = l,
						t.data("$" + c.name + "Controller", l.instance)
					}
					return u
				}
				function X(t, e, n) {
				...
				function tt(t, n, r, a, s, u, l) {
					...
					if (s = null, c.hasOwnProperty(n)) {
						...
						for (var p = 0, d = n.length; p < d; p++)
							try {
								if (h = n[p], (m(a) || a > h.priority) && -1 != h.restrict.indexOf(r)) {
									if (u && (h = f(h, {
													$$start : u,
													$$end : l
												})), !h.$$bindings) {
										...
										if (g(v.scope) && (!0 === v.bindToController ? (b.bindToController = i(v.scope, y, !0), b.isolateScope = {}) : b.isolateScope = i(v.scope, y, !1)), g(v.bindToController) && (b.bindToController = i(v.bindToController, y, !0)), g(b.bindToController)) {
											var w = v.controller,
											x = v.controllerAs;
											if (!w)
												throw Zr("noctrl", y);
				...
				function it(t, e, n, i, o, s, u, c) {
					...
					v = S($.templateUrl) ? $.templateUrl(e, n) : $.templateUrl,
					y = $.templateNamespace;
					return e.empty(),
					a(v).then(function (a) {
						var f,
						b;
						if (a = Ct(a), $.replace) {
							if (a = Er.test(a) ? Xt(ct(y, ur(a))) : [], f = a[0], 1 != a.length || 1 !== f.nodeType)
								throw Zr("tplrt", $.name, v);
							a = {
								$attr : {}
							},
							ht(i, e, f);
							...
							f = d, e.html(a);
						for (t.unshift(m), l = J(t, f, n, o, e, $, s, u, c), r(i, function (t, n) {
								t == f && (i[n] = e[0])
							}), h = q(e[0].childNodes, o); p.length; ) {
							a = p.shift(),
							b = p.shift();
							var x = p.shift(),
							S = p.shift(),
							...
							if (!a.$$destroyed) {
								if (b !== d) {
									var C = b.className;
									c.hasElementTranscludeDirective && $.replace || (w = $t(f)),
									ht(x, zn(b), w),
									U(zn(w), C)
								}
								b = l.transcludeOnThisElement ? B(a, l.transclude, S) : S,
								l(h, a, w, i, b)
							}
						}
						p = null
					...
					function (t, e, n, r, i) {
						t = i,
						e.$$destroyed || (p ? p.push(e, n, r, t) : (l.transcludeOnThisElement && (t = B(e, l.transclude, i)), l(h, e, n, r, t)))
					}
				}
				function ot(t, e) {
				...
				function st(t, e, n, r) {
					...
					if (e)
						throw Zr("multidir", e.name, i(e.$$moduleName), n.name, i(n.$$moduleName), t, L(r))
				}
				function ut(t, e) {
					var r = n(e, !0);
					r && t.push({
						...
						compile : function (t) {
							t = t.parent();
							var e = !!t.length;
							return e && _.$$addBindingClass(t),
							function (t, n) {
								var i = n.parent();
								e || _.$$addBindingClass(i),
								_.$$addBindingInfo(i, r.expressions),
				...
				function lt(t, e) {
					if ("srcdoc" == e)
						return M.HTML;
					var n = T(t);
					return "xlinkHref" == e || "form" == n && "action" == e || "img" != n && ("src" == e || "ngSrc" == e) ? M.RESOURCE_URL : void 0
				}
				function ft(t, e, r, i, o) {
					var a = lt(t, i);
					o = y[i] || o;
					var s = n(r, !0, a, o);
					if (s) {
						if ("multiple" === i && "select" === T(t))
							throw Zr("selmulti", L(t));
						e.push({
							priority : 100,
							compile : function () {
								return {
									pre : function (t, e, u) {
										if (e = u.$$observers || (u.$$observers = at()), x.test(i))
											throw Zr("nodomevents");
										var c = u[i];
										c !== r && (s = c && n(c, !0, a, o), r = c),
										s && (u[i] = s(t), (e[i] || (e[i] = [])).$$inter = !0, (u.$$observers && u.$$observers[i].$$scope || t).$watch(s, function (t, e) {
				...
				function ht(e, n, r) {
					...
					for (u && u.replaceChild(r, a), e = t.document.createDocumentFragment(), i = 0; i < s; i++)
						e.appendChild(n[i]);
					for (zn.hasData(a) && (zn.data(r, zn.data(a)), zn(a).off("$destroy")), zn.cleanData(e.querySelectorAll("*")), i = 1; i < s; i++)
						delete n[i];
					n[0] = r,
					n.length = 1
				}
				...
				function vt(t, e, i, o, a) {
					function u(e, n, r) {
						S(i.$onChanges) && n !== r && (gt || (t.$$postDigest(D), gt = []), l || (l = {}, gt.push(c)), l[e] && (r = l[e].previousValue), l[e] = new Jt(r, n))
					}
					function c() {
						i.$onChanges(l),
						l = void 0
					...
					return r(o, function (r, o) {
						...
						switch (r.mode) {
						case "@":
							v || Jn.call(e, m) || (i[o] = e[m] = void 0),
							e.$observe(m, function (t) {
								(b(t) || A(t)) && (u(o, t, i[o]), i[o] = t)
							}),
							e.$$observers[m].$$scope = t,
							c = e[m],
							b(c) ? i[o] = n(c)(t) : A(c) && (i[o] = c),
							p[o] = new Jt(Jr, i[o]);
							break;
						case "=":
							if (!Jn.call(e, m)) {
							...
							if (v && !e[m])
								break;
							l = s(e[m]),
							$ = l.literal ? I : function (t, e) {
								return t === e || t !== t && e !== e
							},
							d = l.assign || function () {
								throw c = i[o] = l(t),
								Zr("nonassign", e[m], m, a.name)
							},
							c = i[o] = l(t),
							v = function (e) {
								return $(e, i[o]) || ($(e, c) ? d(t, e = i[o]) : i[o] = e),
								c = e
							},
							v.$stateful = !0,
							v = r.collection ? t.$watchCollection(e[m], v) : t.$watch(s(e[m], v), null, l.literal),
							f.push(v);
							break;
						case "<":
							if (!Jn.call(e, m)) {
							...
							break;
						case "&":
							if (l = e.hasOwnProperty(m) ? s(e[m]) : h, l === h && v)
								break;
							i[o] = function (e) {
								return l(t, e)
							}
				...
				R.prototype = {
					$normalize : Kt,
					$addClass : function (t) {
						t && 0 < t.length && N.addClass(this.$$element, t)
					},
					$removeClass : function (t) {
						t && 0 < t.length && N.removeClass(this.$$element, t)
					},
					$updateClass : function (t, e) {
						var n = Yt(t, e);
						n && n.length && N.addClass(this.$$element, n),
						(n = Yt(e, t)) && n.length && N.removeClass(this.$$element, n)
					},
					$set : function (t, e, n, i) {
						var a = Nt(this.$$element[0], t),
						s = jr[t],
						u = t;
						if (a ? (this.$$element.prop(t, e), i = a) : s && (this[s] = e, u = s), this[t] = e, i ? this.$attr[t] = i : (i = this.$attr[t]) || (this.$attr[t] = i = Q(t, "-")), a = T(this.$$element), "a" === a && ("href" === t || "xlinkHref" === t) || "img" === a && "src" === t)
							this[t] = e = j(e, "src" === t);
						else if ("img" === a && "srcset" === t && v(e)) {
							for (var a = "", s = ur(e), c = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, c = /\s/.test(s) ? c : /(,)/, s = s.split(c), c = Math.floor(s.length / 2), l = 0; l < c; l++)
								var f = 2 * l, a = a + j(ur(s[f]), !0), a = a + (" " + ur(s[f + 1]));
							s = ur(s[2 * l]).split(/\s/),
							a += j(ur(s[0]), !0),
							2 === s.length && (a += " " + ur(s[1])),
							this[t] = e = a
						}
						!1 !== n && (null === e || m(e) ? this.$$element.removeAttr(i) : yt.test(i) ? this.$$element.attr(i, e) : F(this.$$element[0], i, e)),
						(t = this.$$observers) && r(t[u], function (t) {
							try {
								t(e)
							} catch (n) {
								o(n)
				...
				St = n.endSymbol(),
				Ct = "{{" == xt && "}}" == St ? p : function (t) {
					return t.replace(/\{\{/g, xt).replace(/}}/g, St)
				},
				Et = /^ngAttr[A-Z]/,
				kt = /^(.+)Start$/;
				return _.$$addBindingInfo = E ? function (t, e) {
					var n = t.data("$binding") || [];
					ar(e) ? n = n.concat(e) : n.push(e),
					t.data("$binding", n)
				}
				 : h,
				_.$$addBindingClass = E ? function (t) {
					U(t, "ng-binding")
				}
				 : h,
				_.$$addScopeInfo = E ? function (t, e, n, r) {
					t.data(n ? r ? "$isolateScopeNoTemplate" : "$isolateScope" : "$scope", e)
				}
				 : h,
				_.$$addScopeClass = E ? function (t, e) {
					U(t, e ? "ng-isolate-scope" : "ng-scope")
				}
				 : h,
				_.$$createComment = function (e, n) {
					var r = "";
					return E && (r = " " + (e || "") + ": ", n && (r += n + " ")),
		...
		this.$get = ["$injector", "$window", function (r, i) {
				...
				return function (e, a, s, c) {
					...
					if (s = !0 === s, c && b(c) && (h = c), b(e)) {
						...
						f = c[1],
						h = h || c[3],
						e = t.hasOwnProperty(f) ? t[f] : it(a.$scope, f, !0) || (n ? it(i, f, !0) : void 0),
						nt(e, f, !0)
					}
					return s ? (s = (ar(e) ? e[e.length - 1] : e).prototype, l = Object.create(s || null), h && o(a, h, l, f || e.name), u(function () {
							var t = r.invoke(e, l, a, f);
							return t !== l && (g(t) || S(t)) && (l = t, h && o(a, h, l, f || e.name)),
							l
						}, {
							instance : l,
							identifier : h
						})) : (l = r.instantiate(e, a, f), h && o(a, h, l, f || e.name), l)
				}
			}
		]
	}
	...
	function re(t) {
		return g(t) ? x(t) ? t.toISOString() : F(t) : t
	}
	function ie() {
		this.$get = function () {
			return function (t) {
				...
				return i(t, function (t, n) {
					null === t || m(t) || (ar(t) ? r(t, function (t) {
							e.push(G(n) + "=" + G(re(t)))
						}) : e.push(G(n) + "=" + G(re(t))))
				}),
				e.join("&")
	...
	function oe() {
		this.$get = function () {
			return function (t) {
				function e(t, o, a) {
					null === t || m(t) || (ar(t) ? r(t, function (t, n) {
							e(t, o + "[" + (g(t) ? n : "") + "]")
	...
	function ae(t, e) {
		if (b(t)) {
			...
			if (n) {
				...
				(r = r && 0 === r.indexOf(ti)) || (r = (r = n.match(ni)) && ri[r[0]].test(n)),
				r && (t = U(n))
			}
		}
		return t
	...
	function ue(t) {
		...
		return function (n) {
			return e || (e = se(t)),
			n ? (n = e[Kn(n)], void 0 === n && (n = null), n) : e
		}
	}
	function ce(t, e, n, i) {
	...
	function le() {
		var t = this.defaults = {
			...
			transformRequest : [function (t) {
					return g(t) && "[object File]" !== er.call(t) && "[object Blob]" !== er.call(t) && "[object FormData]" !== er.call(t) ? F(t) : t
				}
			],
			headers : {
				common : {
		...
		this.$get = ["$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, s, c, l, f, h) {
				function p(n) {
					...
					function s(t) {
						var e = u({}, t);
						return e.data = ce(t.data, t.headers, t.status, c.transformResponse),
						t = t.status,
						200 <= t && 300 > t ? e : f.reject(e)
					}
					if (!g(n))
					...
					(n),
					c.method = Yn(c.method),
					c.paramSerializer = b(c.paramSerializer) ? h.get(c.paramSerializer) : c.paramSerializer;
					var l = [],
					p = [],
					$ = f.when(c);
					return r(w, function (t) {
						(t.request || t.requestError) && l.unshift(t.request, t.requestError),
						(t.response || t.responseError) && p.push(t.response, t.responseError)
					}),
					$ = o($, l),
					$ = $.then(function (e) {
							var n = e.headers,
							i = ce(e.data, ue(n), void 0, e.transformRequest);
							return m(i) && r(n, function (t, e) {
								"content-type" === Kn(e) && delete n[e]
							}),
					...
					i ? ($.success = function (t) {
						...
						$
					}) : ($.success = ai("success"), $.error = ai("error")),
					$
				}
				function d(e, i) {
					function o(t) {
					...
					function u(t, e, r, i) {
						...
						b && (200 <= t && 300 > t ? b.put(k, [t, e, se(r), i]) : b.remove(k)),
						n ? l.$applyAsync(o) : (o(), l.$$phase || l.$apply())
					}
					function c(t, n, r, i) {
						n = -1 <= n ? n : 0,
						(200 <= n && 300 > n ? x.resolve : x.reject)({
							data : t,
							status : n,
							headers : ue(r),
							config : e,
					...
					C = x.promise,
					E = e.headers,
					k = $(e.url, e.paramSerializer(e.params));
					return p.pendingRequests.push(e),
					C.then(d, d),
					!e.cache && !t.cache || !1 === e.cache || "GET" !== e.method && "JSONP" !== e.method || (b = g(e.cache) ? e.cache : g(t.cache) ? t.cache : y),
					b && (w = b.get(k), v(w) ? w && S(w.then) ? w.then(h, h) : ar(w) ? c(w[1], w[0], ut(w[2]), w[3]) : c(w, 200, {}, "OK") : b.put(k, C)),
					m(w) && ((w = un(e.url) ? s()[e.xsrfCookieName || t.xsrfCookieName] : void 0) && (E[e.xsrfHeaderName || t.xsrfHeaderName] = w), a(e.method, k, i, u, E, e.timeout, e.withCredentials, e.responseType, o(e.eventHandlers), o(e.uploadEventHandlers))),
					C
				}
				function $(t, e) {
					return 0 < e.length && (t += (-1 == t.indexOf("?") ? "?" : "&") + e),
					t
				}
				var y = c("$http");
	...
	function pe(t, e, n, i, o) {
		...
		return function (o, s, u, c, l, f, p, d, $, g) {
			...
			function b(e, r, i, o, a) {
				...
				x = C = null,
				e(r, i, o, a),
				t.$$completeOutstandingRequest(h)
			}
			if (t.$$incOutstandingRequestCount(), s = s || t.url(), "jsonp" === Kn(o))
				var w = i.createCallback(s), x = a(s, w, function (t, e) {
				...
				if (C.open(o, s, !0), r(l, function (t, e) {
					...
					0 === n && (n = e ? 200 : "file" == sn(s).protocol ? 404 : 0),
					b(c, n, e, C.getAllResponseHeaders(), t)
				}, o = function () {
					b(c, -1, null, null, "")
				}, C.onerror = o, C.onabort = o, r($, function (t, e) {
						C.addEventListener(e, t)
					}), r(g, function (t, e) {
						C.upload.addEventListener(e, t)
					}), p && (C.withCredentials = !0), d)
					try {
						C.responseType = d
					} catch (E) {
						if ("json" !== d)
		...
		this.$get = ["$parse", "$exceptionHandler", "$sce", function (n, r, i) {
				...
				function c(o, c, h, p) {
					...
					if (!o.length || -1 === o.indexOf(t)) {
						var g;
						return c || (c = a(o), g = d(c), g.exp = o, g.expressions = [], g.$$watchDelegate = s),
						g
					}
					p = !!p;
					var y,
					...
					if (h && 1 < E.length && si.throwNoconcat(o), !c || x.length) {
						var A = function (t) {
		...
		this.$get = ["$rootScope", "$window", "$q", "$$q", "$browser", function (t, e, n, r, i) {
				function o(o, s, u, c) {
					...
					y.$$intervalId = p(function () {
							m ? i.defer(l) : t.$evalAsync(l),
							g.notify($++),
							0 < u && $ >= u && (g.resolve($), d(y.$$intervalId), delete a[y.$$intervalId]),
							m || t.$apply()
						}, s),
					a[y.$$intervalId] = g,
					y
	...
	function ve(t, e) {
		...
		e.$$host = n.hostname,
		e.$$port = l(n.port) || li[n.protocol] || null
	}
	function ge(t, e) {
		var n = "/" !== t.charAt(0);
		n && (t = "/" + t);
	...
	function xe(t, e, n) {
		...
		this.$$parseLinkUrl = function (r, i) {
			...
			var o,
			a;
			return v(o = ye(t, r)) ? (a = o, a = v(o = ye(n, o)) ? e + (ye("/", o) || o) : t + a) : v(o = ye(e, r)) ? a = e + o : e == r + "/" && (a = e),
			a && this.$$parse(a),
			!!a
		}
	}
	function Se(t, e, n) {
		...
		this.$$parse = function (r) {
			var i,
			o = ye(t, r) || ye(e, r);
			m(o) || "#" !== o.charAt(0) ? this.$$html5 ? i = o : (i = "", m(o) && (t = r, this.replace())) : (i = ye(n, o), m(i) && (i = o)),
			ge(i, this),
			r = this.$$path;
			var o = t,
			a = /^\/[A-Z]:(\/.*)/;
			0 === i.lastIndexOf(o, 0) && (i = i.replace(o, "")),
	...
	function Ce(t, e, n) {
		...
		this.$$parseLinkUrl = function (r, i) {
			...
			var o,
			a;
			return t == be(r) ? o = r : (a = ye(e, r)) ? o = t + n + a : e === r + "/" && (o = e),
			o && this.$$parse(o),
			!!o
		},
		this.$$compose = function () {
	...
	function Ae() {
		...
		this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (n, r, i, o, a) {
				...
				if (e.enabled) {
					if (!l && e.requireBase)
						throw fi("nobase");
					f = h.substring(0, h.indexOf("/", h.indexOf("//") + 2)) + (l || "/"),
					l = i.history ? xe : Ce
				} else
					f = be(h), l = Se;
				...
				o.on("click", function (t) {
					if (e.rewriteLinks && !t.ctrlKey && !t.metaKey && !t.shiftKey && 2 != t.which && 2 != t.button) {
						for (var i = zn(t.target); "a" !== T(i[0]); )
							if (i[0] === o[0] || !(i = i.parent())[0])
								return;
						var s = i.prop("href"),
						u = i.attr("href") || i.attr("xlink:href");
						g(s) && "[object SVGAnimatedString]" === s.toString() && (s = sn(s.animVal).href),
						d.test(s) || !s || i.attr("target") || t.isDefaultPrevented() || !c.$$parseLinkUrl(s, u) || (t.preventDefault(), c.absUrl() != r.url() && (n.$apply(), a.angular["ff-684208-preventDefault"] = !0))
					}
				}),
				we(c.absUrl()) != we(h) && r.url(c.absUrl(), !0);
				var $ = !0;
				return r.onUrlChange(function (t, e) {
					m(ye(p, t)) ? a.location.href = t : (n.$evalAsync(function () {
								var r,
								i = c.absUrl(),
								o = c.$$state;
								t = we(t),
	...
	function je(t, e) {
		if (t && (t === (0).constructor || t === (!1).constructor || t === "".constructor || t === {}
				.constructor || t === [].constructor || t === Function.constructor))
			throw pi("isecaf", e)
	}
	function Ie(t, e) {
	...
	function Pe(t, e) {
		...
		case bi.BinaryExpression:
			...
			break;
		case bi.LogicalExpression:
			Pe(t.left, e),
			Pe(t.right, e),
			t.constant = t.left.constant && t.right.constant,
			t.toWatch = t.constant ? [] : [t];
			break;
		case bi.ConditionalExpression:
			Pe(t.test, e),
			Pe(t.alternate, e),
			Pe(t.consequent, e),
		...
		case bi.Identifier:
			...
			t.toWatch = [t];
			break;
		case bi.MemberExpression:
			Pe(t.object, e),
			t.computed && Pe(t.property, e),
			t.constant = t.object.constant && (!t.computed || t.property.constant),
			t.toWatch = [t];
			break;
		case bi.CallExpression:
			n = !!t.filter && !e(t.callee.name).$stateful,
			i = [],
			r(t.arguments, function (t) {
				Pe(t, e),
				n = n && t.constant,
				t.constant || i.push.apply(i, t.toWatch)
			}),
			t.constant = n,
			t.toWatch = t.filter && !e(t.callee.name).$stateful ? i : [t];
			break;
		case bi.AssignmentExpression:
			Pe(t.left, e),
			Pe(t.right, e),
			t.constant = t.left.constant && t.right.constant,
			t.toWatch = [t];
			break;
		case bi.ArrayExpression:
			n = !0,
			i = [],
			...
			t.toWatch = i;
			break;
		case bi.ObjectExpression:
			n = !0,
			i = [],
			r(t.properties, function (t) {
				Pe(t.value, e),
				n = n && t.value.constant && !t.computed,
				t.value.constant || i.push.apply(i, t.value.toWatch)
			}),
			t.constant = n,
			t.toWatch = i;
			break;
		case bi.ThisExpression:
			t.constant = !1,
			t.toWatch = [];
			break;
		case bi.LocalsExpression:
			t.constant = !1,
			t.toWatch = []
		}
	}
	...
	function Fe(t) {
		return t.type === bi.Identifier || t.type === bi.MemberExpression
	}
	function Ue(t) {
		if (1 === t.body.length && Fe(t.body[0].expression))
			return {
				type : bi.AssignmentExpression,
				left : t.body[0].expression,
				right : {
					type : bi.NGValueParameter
				},
				operator : "="
			}
	}
	function _e(t) {
		return 0 === t.body.length || 1 === t.body.length && (t.body[0].expression.type === bi.Literal || t.body[0].expression.type === bi.ArrayExpression || t.body[0].expression.type === bi.ObjectExpression)
	}
	function qe(t, e) {
		this.astBuilder = t,
		this.$filter = e
	...
	function He(t) {
		return S(t.valueOf) ? t.valueOf() : xi.call(t)
	}
	function ze() {
		var t,
		e,
		...
		this.$get = ["$filter", function (a) {
				function s(t, e, r) {
					...
					case "string":
						...
						if (o = m[c], !o) {
							...
							o = r ? y : g;
							var v = new yi(o);
							o = new wi(v, a, o).parse(t),
							o.constant ? o.$$watchDelegate = d : s ? o.$$watchDelegate = o.literal ? p : f : o.inputs && (o.$$watchDelegate = l),
							r && (o = u(o)),
							m[c] = o
						}
						return $(o, e);
				...
				function u(t) {
					...
					if (!t)
						return t;
					e.$$watchDelegate = t.$$watchDelegate,
					e.assign = u(t.assign),
					e.constant = t.constant,
					e.literal = t.literal;
					for (var n = 0; t.inputs && n < t.inputs.length; ++n)
						t.inputs[n] = u(t.inputs[n]);
					return e.inputs = t.inputs,
					e
				}
				function c(t, e) {
				...
				function l(t, e, n, r, i) {
					...
					if (1 === a.length) {
						...
						return t.$watch(function (t) {
							var e = a(t);
							return c(e, s) || (o = r(t, void 0, void 0, [e]), s = e && He(e)),
							o
						}, e, n, i)
					}
					...
					return t.$watch(function (t) {
						...
						return e && (o = r(t, void 0, void 0, l)),
						o
					}, e, n, i)
				}
				function f(t, e, n, r) {
					...
					return i = t.$watch(function (t) {
							...
							o = t,
							S(e) && e.apply(this, arguments),
							v(t) && r.$$postDigest(function () {
								v(o) && i()
							})
						}, n)
				}
				function p(t, e, n, i) {
					...
					return a = t.$watch(function (t) {
							...
							s = t,
							S(e) && e.call(this, t, n, r),
							o(t) && r.$$postDigest(function () {
								o(s) && a()
							})
						}, n)
				}
				...
				function $(t, e) {
					...
					r = !1,
					n = n !== p && n !== f ? function (n, i, o, a) {
						return o = r && a ? a[0] : t(n, i, o, a),
						e(o, n, i)
					}
					 : function (n, r, i, o) {
						return i = t(n, r, i, o),
					...
					return t.$$watchDelegate && t.$$watchDelegate !== l ? n.$$watchDelegate = t.$$watchDelegate : e.$stateful || (n.$$watchDelegate = l, r = !t.inputs, n.inputs = t.inputs ? t.inputs : [t]),
					n
				}
				var m = lr().noUnsafeEval,
				g = {
					csp : m,
					expensiveChecks : !1,
					literals : j(o),
	...
	function Ze(t, n) {
		...
		l = function () {
			var t = new s;
			return t.resolve = o(t, t.resolve),
			t.reject = o(t, t.reject),
			t.notify = o(t, t.notify),
			t
		};
		u(i.prototype, {
			then : function (t, e, n) {
				...
				0 < this.$$state.status && a(this.$$state),
				r.promise
			},
			"catch" : function (t) {
		...
		u(s.prototype, {
			...
			$$resolve : function (t) {
				...
				try {
					(g(t) || S(t)) && (i = t && t.then),
					S(i) ? (this.promise.$$state.status = -1, i.call(t, e, r, o(this, this.notify))) : (this.promise.$$state.value = t, this.promise.$$state.status = 1, a(this.promise.$$state))
				} catch (c) {
					r(c),
					n(c)
				}
	...
	function Ke() {
		...
		this.$get = ["$exceptionHandler", "$parse", "$browser", function (e, u, c) {
				...
				function f(t) {
					9 === Hn && (t.$$childHead && f(t.$$childHead), t.$$nextSibling && f(t.$$nextSibling)),
				...
				p.prototype = {
					...
					$new : function (e, n) {
						var r;
						return n = n || this,
						e ? (r = new p, r.$root = this.$root) : (this.$$ChildScope || (this.$$ChildScope = t(this)), r = new this.$$ChildScope),
						r.$parent = n,
						r.$$prevSibling = n.$$childTail,
						n.$$childHead ? (n.$$childTail.$$nextSibling = r, n.$$childTail = r) : n.$$childHead = n.$$childTail = r,
						(e || n != this) && r.$on("$destroy", l),
						r
					},
					...
					$watchCollection : function (t, e) {
						function r(t) {
							...
							if (!m(i)) {
								if (g(i))
									if (n(i))
										for (o !== h && (o = h, $ = o.length = 0, l++), t = i.length, $ !== t && (l++, o.length = $ = t), e = 0; e < t; e++)
											s = o[e], a = i[e], r = s !== s && a !== a, r || s === a || (l++, o[e] = a);
									else {
										o !== p && (o = p = {}, $ = 0, l++),
										t = 0;
										for (e in i)
											Jn.call(i, e) && (t++, a = i[e], s = o[e], e in o ? (r = s !== s && a !== a, r || s === a || (l++, o[e] = a)) : ($++, o[e] = a, l++));
										if ($ > t)
											for (e in l++, o)
												Jn.call(i, e) || ($--, delete o[e])
									}
								else
									o !== i && (o = i, l++);
								return l
					...
					$digest : function () {
						...
						d("$digest"),
						c.$$checkUrlChange(),
						this === x && null !== s && (c.defer.cancel(s), b()),
						a = null;
						do {
							...
							t : do {
								if (f = $.$$watchers)
									for (h = f.length; h--; )
										try {
											if (t = f[h])
												if (l = t.get, (n = l($)) === (r = t.last) || (t.eq ? I(n, r) : "number" == typeof n && "number" == typeof r && isNaN(n) && isNaN(r))) {
													if (t === a) {
														p = !1;
														break t
													}
												} else
													p = !0, a = t, t.last = t.eq ? j(n, null) : n, u = t.fn, u(n, r === y ? n : r, $), 5 > g && (m = 4 - g, w[m] || (w[m] = []), w[m].push({
							...
							if ((p || C.length) && !g--)
								throw x.$$phase = null, o("infdig", i, w)
						} while (p || C.length);
						for (x.$$phase = null; A < E.length; )
							try {
								E[A++]()
							} catch (M) {
								e(M)
					...
					$destroy : function () {
						if (!this.$$destroyed) {
							...
							this.$$destroyed = !0,
							this === x && c.$$applicationDestroyed(),
							$(this, -this.$$watchersCount);
							for (var e in this.$$listenerCount)
								v(this, this.$$listenerCount[e], e);
	...
	function tn() {
		...
		this.resourceUrlWhitelist = function (e) {
			return arguments.length && (t = Qe(e)),
			t
		},
		this.resourceUrlBlacklist = function (t) {
			return arguments.length && (e = Qe(t)),
			e
		},
		this.$get = ["$injector", function (n) {
				...
				var a = i(),
				s = {};
				return s[Ci.HTML] = i(a),
				s[Ci.CSS] = i(a),
				s[Ci.URL] = i(a),
				s[Ci.JS] = i(a),
				s[Ci.RESOURCE_URL] = i(s[Ci.URL]), {
					trustAs : function (t, e) {
						var n = s.hasOwnProperty(t) ? s[t] : null;
						if (!n)
							throw Si("icontext", t, e);
						if (null === e || m(e) || "" === e)
							return e;
						if ("string" != typeof e)
							throw Si("itype", t);
	...
	function nn() {
		this.$get = ["$window", "$document", function (t, e) {
				var n,
				r = {},
				i = !(t.chrome && t.chrome.app && t.chrome.app.runtime) && t.history && t.history.pushState,
				o = l((/android (\d+)/.exec(Kn((t.navigator || {}).userAgent)) || [])[1]),
				...
				if (c) {
					...
					!o || f && h || (f = b(c.webkitTransition), h = b(c.webkitAnimation))
				}
				return {
					history : !(!i || 4 > o || a),
					hasEvent : function (t) {
	...
	function rn() {
		...
		this.$get = ["$templateCache", "$http", "$q", "$sce", function (e, n, r, i) {
				function o(a, s) {
					...
					b(a) && !m(e.get(a)) || (a = i.getTrustedResourceUrl(a));
					var c = n.defaults && n.defaults.transformResponse;
					return ar(c) ? c = c.filter(function (t) {
							return t !== ae
						}) : c === ae && (c = null),
					n.get(a, u({
							cache : e,
						...
						return e.put(a, t.data),
						t.data
					}, function (t) {
						if (!s)
							throw Ei("tpload", a, t.status, t.statusText);
						return r.reject(t)
					})
				}
		...
		this.$get = ["$rootScope", "$browser", "$location", function (t, e, n) {
				return {
					findBindings : function (t, e, n) {
						...
						var i = [];
						return r(t, function (t) {
							var o = ir.element(t).data("$binding");
							o && r(o, function (r) {
								n ? new RegExp("(^|\\s)" + cr(e) + "(\\s|\\||$)").test(r) && i.push(t) : -1 != r.indexOf(e) && i.push(t)
							})
						}),
						i
					},
	...
	function sn(t) {
		return Hn && (ki.setAttribute("href", t), t = ki.href),
		ki.setAttribute("href", t), {
			href : ki.href,
	...
	function un(t) {
		return t = b(t) ? sn(t) : t,
		t.protocol === Ai.protocol && t.host === Ai.host
	}
	function cn() {
		this.$get = d(t)
	}
		...
		return function () {
			...
			if (t = n.cookie || "", t !== i)
				for (i = t, t = i.split("; "), r = {}, a = 0; a < t.length; a++)
					o = t[a], s = o.indexOf("="), 0 < s && (u = e(o.substring(0, s)), m(r[u]) && (r[u] = e(o.substring(s + 1))));
			return r
		}
	}
	function fn() {
	...
	function dn(t, e, n, r) {
		...
		return !0 === e ? e = I : S(e) || (e = function (t, e) {
				return !m(t) && (null === t || null === e ? t === e : !(g(e) || g(t) && !$(t)) && (t = Kn("" + t), e = Kn("" + e), -1 !== t.indexOf(e)))
			}),
		function (o) {
	...
	function $n(t, e, n, r, i, o) {
		...
		if ("string" === s && "!" === e.charAt(0))
			return !$n(t, e.substring(1), n, r, i);
		if (ar(t))
		...
		case "object":
			...
			if (i) {
				for (u in t)
					if ("$" !== u.charAt(0) && $n(t[u], e, n, r, !0))
						return !0;
				return !o && $n(t, e, n, r, !1)
			}
			if ("object" === s) {
				for (u in e)
					if (o = e[u], !S(o) && !m(o) && (a = u === r, !$n(a ? t : t[u], o, n, r, a, a)))
						return !1;
				return !0
			}
			return n(t, e);
	...
	function vn(t) {
		...
		return function (t, n, r) {
			...
			null == t ? t : wn(t, e.PATTERNS[1], e.GROUP_SEP, e.DECIMAL_SEP, r).replace(/\u00A4/g, n)
		}
	}
	function gn(t) {
		var e = t.NUMBER_FORMATS;
	...
	function yn(t) {
		...
		o,
		a = 0;
		for (-1 < (n = t.indexOf(Mi)) && (t = t.replace(Mi, "")), 0 < (r = t.search(/e/i)) ? (0 > n && (n = r), n += +t.slice(r + 1), t = t.substring(0, r)) : 0 > n && (n = t.length), r = 0; t.charAt(r) == Ni; r++);
		if (r == (o = t.length))
			e = [0], n = 1;
		else {
			for (o--; t.charAt(o) == Ni; )
		...
		return n > Oi && (e = e.splice(0, Oi - 1), a = n - 1, n = 1), {
			d : e,
			e : a,
			i : n
		}
	...
	function bn(t, e, n, r) {
		var i = t.d,
		o = i.length - t.i;
		if (e = m(e) ? Math.min(Math.max(n, o), r) : +e, n = e + t.i, r = i[n], 0 < n) {
	...
	function kn(t) {
		return function (e) {
			...
			return e = +new Date(e.getFullYear(), e.getMonth(), e.getDate() + (4 - e.getDay())) - +n,
			e = 1 + Math.round(e / 6048e5),
			xn(e, t)
		}
	}
	function An(t, e) {
	...
	function On(t) {
		function e(t) {
			...
			if (e = t.match(n)) {
				...
				e[9] && (r = l(e[9] + e[10]), i = l(e[9] + e[11])),
				o.call(t, l(e[1]), l(e[2]) - 1, l(e[3])),
				r = l(e[4] || 0) - r,
				i = l(e[5] || 0) - i,
				o = l(e[6] || 0),
		...
		return function (n, i, o) {
			...
			u = "",
			c = [];
			if (i = i || "mediumDate", i = t.DATETIME_FORMATS[i] || i, b(n) && (n = ji.test(n) ? l(n) : e(n)), w(n) && (n = new Date(n)), !x(n) || !isFinite(n.getTime()))
				return n;
			for (; i; )
				(s = Vi.exec(i)) ? (c = D(c, s, 1), i = c.pop()) : (c.push(i), i = null);
			var f = n.getTimezoneOffset();
			return o && (f = _(o, f), n = q(n, o, !0)),
			r(c, function (e) {
				a = Ti[e],
				u += a ? a(n, t.DATETIME_FORMATS, f) : "''" === e ? "'" : e.replace(/(^'|'$)/g, "").replace(/''/g, "'")
			}),
			u
		}
	}
	...
	function Nn() {
		return function (t, e, r) {
			return e = 1 / 0 === Math.abs(Number(e)) ? Number(e) : l(e),
			isNaN(e) ? t : (w(t) && (t = t.toString()), n(t) ? (r = !r || isNaN(r) ? 0 : l(r), r = 0 > r ? Math.max(0, t.length + r) : r, 0 <= e ? Tn(t, r, r + e) : 0 === r ? Tn(t, e, t.length) : Tn(t, Math.max(0, r + e), r)) : t)
		}
	}
	function Tn(t, e, n) {
		return b(t) ? t.slice(e, n) : Xn.call(t, e, n)
	}
	function Vn(t) {
		function r(e) {
			return e.map(function (e) {
				...
				if (S(e))
					r = e;
				else if (b(e) && ("+" != e.charAt(0) && "-" != e.charAt(0) || (n = "-" == e.charAt(0) ? -1 : 1, e = e.substring(1)), "" !== e && (r = t(e), r.constant)))
		...
		function o(t, e) {
			...
			if (r === i) {
				var i = t.value,
				o = e.value;
				"string" === r ? (i = i.toLowerCase(), o = o.toLowerCase()) : "object" === r && (g(i) && (i = t.index), g(o) && (o = e.index)),
				i !== o && (n = i < o ? -1 : 1)
			} else
				n = r < i ? -1 : 1;
			return n
			...
			return t = Array.prototype.map.call(t, function (t, e) {
					return {
						...
						predicateValues : c.map(function (n) {
							var r = n.get(t);
							return n = typeof r,
							null === r ? (n = "string", r = "null") : "object" === n && (S(r.valueOf) && (r = r.valueOf(), i(r)) || $(r) && (r = r.toString(), i(r))), {
								value : r,
								type : n,
								index : e
							}
	...
	function In(t, e, n, i, o) {
		...
		a.$setDirty = function () {
			...
			a.$dirty = !0,
			a.$pristine = !1,
			a.$$parentForm.$setDirty()
		},
		a.$setPristine = function () {
			i.setClass(t, wo, xo + " ng-submitted"),
			a.$dirty = !1,
			a.$pristine = !0,
			a.$submitted = !1,
			r(s, function (t) {
		...
		a.$setSubmitted = function () {
			i.addClass(t, "ng-submitted"),
			a.$submitted = !0,
			a.$$parentForm.$setSubmitted()
		}
	}
	function Dn(t) {
	...
	function Pn(t, e, n, r, i, o) {
		...
		c = function (t) {
			if (u && (o.defer.cancel(u), u = null), !s) {
				...
				(r.$viewValue !== i || "" === i && r.$$hasNativeValidators) && r.$setViewValue(i, t)
			}
		};
		if (i.hasEvent("input"))
			e.on("input", c);
		...
		e.on("change", c),
		Yi[a] && r.$$hasNativeValidators && a === n.type && e.on("keydown wheel mousedown", function (t) {
			if (!u) {
				var e = this.validity,
				n = e.badInput,
				r = e.typeMismatch;
	...
	function Rn(t, e) {
		return function (n, i) {
			...
			if (x(n))
				return n;
			if (b(n)) {
				if ('"' == n.charAt(0) && '"' == n.charAt(n.length - 1) && (n = n.substring(1, n.length - 1)), Li.test(n))
					return new Date(n);
				if (t.lastIndex = 0, o = t.exec(n))
					return o.shift(), a = i ? {
						yyyy : i.getFullYear(),
						MM : i.getMonth() + 1,
						dd : i.getDate(),
	...
	function Fn(t, e, n, r) {
		return function (i, o, a, s, u, c, l) {
			...
			function h(t) {
				return v(t) && !x(t) ? n(t) || void 0 : t
			}
			Un(i, o, a, s),
			Pn(i, o, a, s, u, c);
			var p,
			d = s && s.$options && s.$options.timezone;
	...
	function Ln(t) {
		...
		s = t.unset,
		u = t.$animate;
		o[bo] = !(o[yo] = i.hasClass(yo)),
		r.$setValidity = function (t, i, o) {
			m(i) ? (r.$pending || (r.$pending = {}), a(r.$pending, t, o)) : (r.$pending && s(r.$pending, t, o), Bn(r.$pending) && (r.$pending = void 0)),
			A(i) ? i ? (s(r.$error, t, o), a(r.$$success, t, o)) : (a(r.$error, t, o), s(r.$$success, t, o)) : (s(r.$error, t, o), s(r.$$success, t, o)),
			r.$pending ? (e(So, !0), r.$valid = r.$invalid = void 0, n("", null)) : (e(So, !1), r.$valid = Bn(r.$error), r.$invalid = !r.$valid, n("", r.$valid)),
			i = r.$pending && r.$pending[t] ? void 0 : !r.$error[t] && (!!r.$$success[t] || null),
			n(t, i),
			r.$$parentForm.$setValidity(t, i, r)
		}
	}
	function Bn(t) {
		if (t)
	...
	fr = function () {
		...
		o = pr.length;
		for (n = 0; n < o; ++n)
			if (r = pr[n], e = t.document.querySelector("[" + r.replace(":", "\\:") + "jq]")) {
	...
	Er = /<|&#?\w+;/,
	kr = /<([\w:-]+)/,
	Ar = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi,
	Or = {
	...
	Or.optgroup = Or.option,
	Or.tbody = Or.tfoot = Or.colgroup = Or.caption = Or.thead,
	Or.th = Or.td;
	var Mr = t.Node.prototype.contains || function (t) {
	...
	r({
		...
		css : function (t, e, n) {
			return e = lt(e),
			v(n) ? void(t.style[e] = n) : t.style[e]
		},
		attr : function (t, e, n) {
			var r = t.nodeType;
			if (r !== mr && 2 !== r && 8 !== r)
				if (r = Kn(e), Tr[r]) {
					if (!v(n))
						return t[e] || (t.attributes.getNamedItem(e) || h).specified ? r : void 0;
					n ? (t[e] = !0, t.setAttribute(e, r)) : (t[e] = !1, t.removeAttribute(r))
				} else if (v(n))
					t.setAttribute(e, n);
				else if (t.getAttribute)
					return t = t.getAttribute(e, 2), null === t ? void 0 : t
		},
		prop : function (t, e, n) {
		...
		html : function (t, e) {
			return m(e) ? t.innerHTML : (mt(t, !0), void(t.innerHTML = e))
		},
		empty : At
	}, function (t, e) {
		dt.prototype[e] = function (e, n) {
			...
			i,
			o = this.length;
			if (t !== At && m(2 == t.length && t !== wt && t !== Et ? e : n)) {
				if (g(e)) {
					for (r = 0; r < o; r++)
						if (t === bt)
							t(this[r], e);
				...
				for (r = t.$dv, o = m(r) ? Math.min(o, 1) : o, i = 0; i < o; i++) {
					var a = t(this[i], e, n);
					r = r ? r + a : a
				}
				return r
	...
	r({
		...
		on : function (t, e, n, r) {
			...
			if (ft(t)) {
				...
				o = r.handle;
				o || (o = r.handle = Tt(t, i)),
				r = 0 <= e.indexOf(" ") ? e.split(" ") : [e];
				for (var a = r.length, s = function (e, r, a) {
					var s = i[e];
					s || (s = i[e] = [], s.specialHandlerWrapper = r, "$destroy" === e || a || t.addEventListener(e, o, !1)),
					s.push(n)
				}; a--; )
					e = r[a], xr[e] ? (s(xr[e], jt), s(e, void 0, !0)) : s(e)
			}
		},
		off : vt,
		one : function (t, e, n) {
		...
		dt.prototype[e] = function (e, n, r) {
			for (var i, o = 0, a = this.length; o < a; o++)
				m(i) ? (i = t(this[o], e, n, r), v(i) && (i = zn(i))) : Ct(i, t(this[o], e, n, r));
			return v(i) ? i : this
		},
	...
	Ur = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm,
	_r = e("$injector");
	Ut.$$annotate = function (t, e, n) {
		var i;
		if ("function" == typeof t) {
			if (!(i = t.$inject)) {
				if (i = [], t.length) {
					if (e)
						throw b(n) && n || (n = t.name || Ft(t)), _r("strictdi", n);
					e = Rt(t),
					r(e[1].split(Rr), function (t) {
			...
			ar(t) ? (e = t.length - 1, nt(t[e], "fn"), i = t.slice(0, e)) : nt(t, "fn", !0);
		return i
	};
	var qr = e("$animate"),
	Lr = function () {
	...
	Br = function () {
		...
		this.$get = ["$$AnimateRunner", "$rootScope", function (n, i) {
				function o(t, e, n) {
					var i = !1;
					return e && (e = b(e) ? e.split(" ") : ar(e) ? e : [], r(e, function (e) {
							e && (i = !0, t[e] = n)
						})),
					i
				}
				...
				return {
					...
					off : h,
					pin : h,
					push : function (r, s, u, c) {
						return c && c(),
						u = u || {},
						u.from && r.css(u.from),
						u.to && r.css(u.to),
						(u.addClass || u.removeClass) && (s = u.addClass, c = u.removeClass, u = t.get(r) || {}, s = o(u, s, !0), c = o(u, c, !1), (s || c) && (t.put(r, u), e.push(r), 1 === e.length && i.$$postDigest(a))),
						r = new n,
						r.complete(),
						r
					}
	...
	Hr = ["$provide", function (t) {
			...
			this.register = function (n, r) {
				if (n && "." !== n.charAt(0))
					throw qr("notcsel", n);
				var i = n + "-animation";
				e.$$registeredAnimations[n.substr(1)] = i,
				t.factory(i, r)
			},
			this.classNameFilter = function (t) {
				if (1 === arguments.length && (this.$$classNameFilter = t instanceof RegExp ? t : null) && /(\s+|\/)ng-animate(\s+|\/)/.test(this.$$classNameFilter.toString()))
					throw qr("nongcls", "ng-animate");
			...
			this.$get = ["$$animateQueue", function (t) {
					...
					return {
						...
						addClass : function (e, n, r) {
							return r = Bt(r),
							r.addClass = qt(r.addclass, n),
							t.push(e, "addClass", r)
						},
						removeClass : function (e, n, r) {
							return r = Bt(r),
							r.removeClass = qt(r.removeClass, n),
							t.push(e, "removeClass", r)
						},
						setClass : function (e, n, r, i) {
							return i = Bt(i),
							i.addClass = qt(i.addClass, n),
							i.removeClass = qt(i.removeClass, r),
							t.push(e, "setClass", i)
						},
						animate : function (e, n, r, i, o) {
							return o = Bt(o),
							o.from = o.from ? u(o.from, n) : n,
							o.to = o.to ? u(o.to, r) : r,
							o.tempClasses = qt(o.tempClasses, i || "ng-inline-animate"),
							t.push(e, "animate", o)
						}
					}
				}
	...
	Gr = function () {
		this.$get = ["$$rAF", "$q", "$$AnimateRunner", function (t, e, n) {
				return function (e, r) {
					function i() {
						return t(function () {
							o.addClass && (e.addClass(o.addClass), o.addClass = null),
							o.removeClass && (e.removeClass(o.removeClass), o.removeClass = null),
							o.to && (e.css(o.to), o.to = null),
							a || s.complete(),
							a = !0
						}),
						s
					...
					o.from && (e.css(o.from), o.from = null);
					var a,
					s = new n;
					return {
						start : i,
	...
	Jt.prototype.isFirstChange = function () {
		return this.previousValue === Jr
	};
	var Kr = /^((?:x|data)[\:\-_])/i,
	Yr = e("$controller"),
	Xr = /^(\S+)(\s+as\s+([\w$]+))?$/,
	Qr = function () {
		this.$get = ["$document", function (t) {
				return function (e) {
					return e ? !e.nodeType && e instanceof zn && (e = e[0]) : e = t[0].body,
					e.offsetWidth + 1
				}
			}
		]
	...
	si = ir.$interpolateMinErr = e("$interpolate");
	si.throwNoconcat = function (t) {
		throw si("noconcat", t)
	},
	si.interr = function (t, e) {
		return si("interr", t, e.toString())
	};
	var ui = function () {
		this.$get = ["$window", function (t) {
				function e(t) {
	...
	yi.prototype = {
		...
		throwError : function (t, e, n) {
			...
			e = v(e) ? "s " + e + "-" + this.index + " [" + this.text.substring(e, n) + "]" : " " + n,
			pi("lexerr", t, e, this.text)
		},
		readNumber : function () {
		...
		readString : function (t) {
			...
			for (var n = "", r = t, i = !1; this.index < this.text.length; ) {
				...
				r = r + o;
				if (i)
					"u" === o ? (i = this.text.substring(this.index + 1, this.index + 5), i.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + i + "]"), this.index += 4, n += String.fromCharCode(parseInt(i, 16))) : n += gi[o] || o, i = !1;
				else if ("\\" === o)
					i = !0;
				else {
					if (o === t)
	...
	bi.AssignmentExpression = "AssignmentExpression",
	bi.ConditionalExpression = "ConditionalExpression",
	bi.LogicalExpression = "LogicalExpression",
	bi.BinaryExpression = "BinaryExpression",
	bi.UnaryExpression = "UnaryExpression",
	bi.CallExpression = "CallExpression",
	bi.MemberExpression = "MemberExpression",
	bi.Identifier = "Identifier",
	bi.Literal = "Literal",
	bi.ArrayExpression = "ArrayExpression",
	bi.Property = "Property",
	bi.ObjectExpression = "ObjectExpression",
	bi.ThisExpression = "ThisExpression",
	bi.LocalsExpression = "LocalsExpression",
	bi.NGValueParameter = "NGValueParameter",
	bi.prototype = {
		ast : function (t) {
			return this.text = t,
		...
		primary : function () {
			...
			for (var e; e = this.expect("(", "[", "."); )
				"(" === e.text ? (t = {
						type : bi.CallExpression,
						callee : t,
						arguments : this.parseArguments()
					}, this.consume(")")) : "[" === e.text ? (t = {
						type : bi.MemberExpression,
						object : t,
		...
		object : function () {
			...
			return this.consume("}"), {
				type : bi.ObjectExpression,
				properties : e
			}
		},
		throwError : function (t, e) {
			throw pi("syntax", e.text, t, e.index + 1, this.text, this.text.substring(e.index))
		},
		consume : function (t) {
			if (0 === this.tokens.length)
				throw pi("ueoe", this.text);
			var e = this.expect(t);
		...
		selfReferential : {
			"this" : {
				type : bi.ThisExpression
			},
			$locals : {
				type : bi.LocalsExpression
			}
		}
	},
	qe.prototype = {
		compile : function (t, e) {
			...
			(o = Ue(i)) && (this.state.computing = "assign", a = this.nextId(), this.recurse(o, a), this.return_(a), a = "fn.assign=" + this.generateFunction("assign", "s,v,l")),
			o = Re(i.body),
			n.stage = "inputs",
			r(o, function (t, e) {
				var r = "fn" + e;
			...
			a = new Function("$filter", "ensureSafeMemberName", "ensureSafeObject", "ensureSafeFunction", "getStringValue", "ensureSafeAssignContext", "ifDefined", "plus", "text", a)(this.$filter, Me, Te, Ve, Ne, je, Ie, De, t),
			this.state = this.stage = void 0,
			a.literal = _e(i),
			a.constant = i.constant,
			a
		},
		USE : "use",
		STRICT : "strict",
		...
		recurse : function (t, e, n, i, o, a) {
			...
			f,
			p = this;
			if (i = i || h, !a && v(t.watchId))
				e = e || this.nextId(), this.if_("i", this.lazyAssign(e, this.computedMember("i", t.watchId)), this.lazyRecurse(t, e, n, i, o, !0));
			else
				switch (t.type) {
				case bi.Program:
				...
				case bi.UnaryExpression:
					...
					l = t.operator + "(" + this.ifDefined(u, 0) + ")",
					this.assign(e, l),
					i(l);
					break;
				case bi.BinaryExpression:
				...
				case bi.LogicalExpression:
					e = e || this.nextId(),
					p.recurse(t.left, e),
					p.if_("&&" === t.operator ? e : p.not(e), p.lazyRecurse(t.right, e)),
					i(e);
					break;
				case bi.ConditionalExpression:
					e = e || this.nextId(),
					p.recurse(t.test, e),
					p.if_(e, p.lazyRecurse(t.alternate, e), p.lazyRecurse(t.consequent, e)),
					i(e);
					break;
				case bi.Identifier:
					e = e || this.nextId(),
					n && (n.context = "inputs" === p.stage ? "s" : this.assign(this.nextId(), this.getHasOwnProperty("l", t.name) + "?l:s"), n.computed = !1, n.name = t.name),
					Me(t.name),
					p.if_("inputs" === p.stage || p.not(p.getHasOwnProperty("l", t.name)), function () {
						p.if_("inputs" === p.stage || "s", function () {
							o && 1 !== o && p.if_(p.not(p.nonComputedMember("s", t.name)), p.lazyAssign(p.nonComputedMember("s", t.name), "{}")),
							p.assign(e, p.nonComputedMember("s", t.name))
						})
					}, e && p.lazyAssign(e, p.nonComputedMember("l", t.name))),
					(p.state.expensiveChecks || Be(t.name)) && p.addEnsureSafeObject(e),
					i(e);
					break;
				case bi.MemberExpression:
					s = n && (n.context = this.nextId()) || this.nextId(),
					e = e || this.nextId(),
					p.recurse(t.object, s, void 0, function () {
						p.if_(p.notNull(s), function () {
							o && 1 !== o && p.addEnsureSafeAssignContext(s),
							t.computed ? (u = p.nextId(), p.recurse(t.property, u), p.getStringValue(u), p.addEnsureSafeMemberName(u), o && 1 !== o && p.if_(p.not(p.computedMember(s, u)), p.lazyAssign(p.computedMember(s, u), "{}")), l = p.ensureSafeObject(p.computedMember(s, u)), p.assign(e, l), n && (n.computed = !0, n.name = u)) : (Me(t.property.name), o && 1 !== o && p.if_(p.not(p.nonComputedMember(s, t.property.name)), p.lazyAssign(p.nonComputedMember(s, t.property.name), "{}")), l = p.nonComputedMember(s, t.property.name), (p.state.expensiveChecks || Be(t.property.name)) && (l = p.ensureSafeObject(l)), p.assign(e, l), n && (n.computed = !1, n.name = t.property.name))
						}, function () {
				...
				case bi.CallExpression:
					e = e || this.nextId(),
					t.filter ? (u = p.filter(t.callee.name), c = [], r(t.arguments, function (t) {
							var e = p.nextId();
							p.recurse(t, e),
							c.push(e)
						}), l = u + "(" + c.join(",") + ")", p.assign(e, l), i(e)) : (u = p.nextId(), s = {}, c = [], p.recurse(t.callee, u, s, function () {
							p.if_(p.notNull(u), function () {
								p.addEnsureSafeFunction(u),
								r(t.arguments, function (t) {
									p.recurse(t, p.nextId(), void 0, function (t) {
										c.push(p.ensureSafeObject(t))
									})
								}),
								s.name ? (p.state.expensiveChecks || p.addEnsureSafeObject(s.context), l = p.member(s.context, s.name, s.computed) + "(" + c.join(",") + ")") : l = u + "(" + c.join(",") + ")",
								l = p.ensureSafeObject(l),
								p.assign(e, l)
							}, function () {
								p.assign(e, "undefined")
							}),
				...
				case bi.AssignmentExpression:
					...
					this.recurse(t.left, void 0, s, function () {
						p.if_(p.notNull(s.context), function () {
							...
							p.addEnsureSafeAssignContext(s.context),
							l = p.member(s.context, s.name, s.computed) + t.operator + u,
							p.assign(e, l),
							i(e || l)
						})
					}, 1);
				...
				case bi.ObjectExpression:
					...
					f ? (e = e || this.nextId(), this.assign(e, "{}"), r(t.properties, function (t) {
							t.computed ? (s = p.nextId(), p.recurse(t.key, s)) : s = t.key.type === bi.Identifier ? t.key.name : "" + t.key.value,
							u = p.nextId(),
							p.recurse(t.value, u),
							p.assign(p.member(e, s, t.computed), u)
						})) : (r(t.properties, function (e) {
							p.recurse(e.value, t.constant ? void 0 : p.nextId(), void 0, function (t) {
								c.push(p.escape(e.key.type === bi.Identifier ? e.key.name : "" + e.key.value) + ":" + t)
							})
						}), l = "{" + c.join(",") + "}", this.assign(e, l)),
					i(e || l);
					break;
				case bi.ThisExpression:
					this.assign(e, "s"),
		...
		nextId : function (t, e) {
			...
			return t || this.current().vars.push(n + (e ? "=" + e : "")),
			n
		},
		current : function () {
	...
	Le.prototype = {
		compile : function (t, e) {
			...
			i = this.astBuilder.ast(t);
			this.expression = t,
			this.expensiveChecks = e,
			Pe(i, n.$filter);
			var o,
			a;
			(o = Ue(i)) && (a = this.recurse(o)),
			o = Re(i.body);
			var s;
		...
		recurse : function (t, e, n) {
			...
			case bi.UnaryExpression:
				return o = this.recurse(t.argument),
				this["unary" + t.operator](o, e);
			case bi.BinaryExpression:
				return i = this.recurse(t.left),
				o = this.recurse(t.right),
				this["binary" + t.operator](i, o, e);
			case bi.LogicalExpression:
				return i = this.recurse(t.left),
				o = this.recurse(t.right),
				this["binary" + t.operator](i, o, e);
			...
			case bi.Identifier:
				return Me(t.name, s.expression),
				s.identifier(t.name, s.expensiveChecks || Be(t.name), e, n, s.expression);
			case bi.MemberExpression:
				return i = this.recurse(t.object, !1, !!n),
				t.computed || (Me(t.property.name, s.expression), o = t.property.name),
				t.computed && (o = this.recurse(t.property)),
				t.computed ? this.computedMember(i, o, e, n, s.expression) : this.nonComputedMember(i, o, s.expensiveChecks, e, n, s.expression);
			case bi.CallExpression:
				return a = [],
				r(t.arguments, function (t) {
					a.push(s.recurse(t))
				...
				t.filter ? function (t, n, r, i) {
					for (var s = [], u = 0; u < a.length; ++u)
						s.push(a[u](t, n, r, i));
					return t = o.apply(void 0, s, i),
					e ? {
						context : void 0,
						name : void 0,
						value : t
				 ...
				 : function (t, n, r, i) {
					...
					c = o(t, n, r, i);
					if (null != c.value) {
						Te(c.context, s.expression),
						Ve(c.value, s.expression),
						u = [];
						for (var l = 0; l < a.length; ++l)
							u.push(Te(a[l](t, n, r, i), s.expression));
			...
			case bi.AssignmentExpression:
				return i = this.recurse(t.left, !0, 1),
				o = this.recurse(t.right),
				function (t, n, r, a) {
					var u = i(t, n, r, a);
					return t = o(t, n, r, a),
					Te(u.value, s.expression),
					je(u.context),
					u.context[u.name] = t,
					e ? {
						value : t
			...
			case bi.ObjectExpression:
				...
				r(t.properties, function (t) {
					t.computed ? a.push({
						...
						key : t.key.type === bi.Identifier ? t.key.name : "" + t.key.value,
						computed : !1,
						value : s.recurse(t.value)
					})
				}),
		...
		"ternary?:" : function (t, e, n, r) {
			return function (i, o, a, s) {
				return i = t(i, o, a, s) ? e(i, o, a, s) : n(i, o, a, s),
				r ? {
					value : i
				}
				 : i
		...
		computedMember : function (t, e, n, r, i) {
			return function (o, a, s, u) {
				...
				l,
				f = t(o, a, s, u);
				return null != f && (c = e(o, a, s, u), c += "", Me(c, i), r && 1 !== r && (je(f), f && !f[c] && (f[c] = {})), l = f[c], Te(l, i)),
				n ? {
					context : f,
					name : c,
					value : l
	...
	var wi = function (t, e, n) {
		...
		this.options = n,
		this.ast = new bi(t, n),
		this.astCompiler = n.csp ? new Le(this.ast, e) : new qe(this.ast, e)
	};
	wi.prototype = {
		constructor : wi,
		parse : function (t) {
	...
	var xi = Object.prototype.valueOf,
	Si = e("$sce"),
	Ci = {
		HTML : "html",
		CSS : "css",
	...
	Ei = e("$compile"),
	ki = t.document.createElement("a"),
	Ai = sn(t.location.href);
	ln.$inject = ["$document"],
	hn.$inject = ["$provide"];
	var Oi = 22,
	Mi = ".",
	...
	var Ti = {
		...
		Z : function (t, e, n) {
			return t = -1 * n,
			t = (0 <= t ? "+" : "") + (xn(Math[0 < t ? "floor" : "ceil"](t / 60), 2) + xn(Math.abs(t % 60), 2))
		},
		ww : kn(2),
		w : kn(1),
		G : An,
				...
				if (!e.href && !e.xlinkHref)
					return function (t, e) {
						if ("a" === e[0].nodeName.toLowerCase()) {
							var n = "[object SVGAnimatedString]" === er.call(e.prop("href")) ? "xlink:href" : "href";
	...
	r(jr, function (t, e) {
		Ri[e] = function () {
			return {
				priority : 100,
				link : function (t, n, r) {
					return "ngPattern" === e && "/" == r.ngPattern.charAt(0) && (n = r.ngPattern.match(Zn)) ? void r.$set("ngPattern", new RegExp(n[1], n[2])) : void t.$watch(r[e], function (t) {
						r.$set(e, t)
					})
				}
			}
		...
		Ri[e] = function () {
			return {
				...
				link : function (n, r, i) {
					var o = t,
					a = t;
					"href" === t && "[object SVGAnimatedString]" === er.call(r.prop("href")) && (a = "xlinkHref", i.$attr[a] = "xlink:href", o = null),
					i.$observe(e, function (e) {
						e ? (i.$set(a, e), Hn && o && r.prop(o, i[a])) : "href" === t && i.$set(a, null)
					})
				}
			}
		}
						...
						return {
							pre : function (t, n, i, a) {
								...
								if (!("action" in i)) {
									...
									n[0].addEventListener("submit", c, !1),
	...
	_i = Ui(),
	qi = Ui(!0),
	Li = /^\d{4,}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+(?:[+-][0-2]\d:[0-5]\d|Z)$/,
	Bi = /^[a-z][a-z\d.+-]*:\/*(?:[^:@]+(?::[^@]+)?@)?(?:[^\s:\/?#]+|\[[a-f\d:]+\])(?::\d+)?(?:\/[^?#]*)?(?:\?[^#]*)?(?:#.*)?$/i,
	...
	var Xi = {
		...
		date : Fn("date", Wi, Rn(Wi, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
		"datetime-local" : Fn("datetimelocal", Gi, Rn(Gi, "yyyy MM dd HH mm ss sss".split(" ")), "yyyy-MM-ddTHH:mm:ss.sss"),
		time : Fn("time", Ki, Rn(Ki, ["HH", "mm", "ss", "sss"]), "HH:mm:ss.sss"),
		week : Fn("week", Zi, function (t, e) {
			if (x(t))
				return t;
			if (b(t)) {
				Zi.lastIndex = 0;
				...
				if (n) {
					...
					u = En(r),
					i = 7 * (i - 1);
					return e && (n = e.getHours(), o = e.getMinutes(), a = e.getSeconds(), s = e.getMilliseconds()),
					new Date(r, 0, u.getDate() + i, n, o, a, s)
				}
			}
			return NaN
		}, "yyyy-Www"),
		month : Fn("month", Ji, Rn(Ji, ["yyyy", "MM"]), "yyyy-MM"),
		number : function (t, e, n, r, i, o) {
			if (Un(t, e, n, r), Pn(t, e, n, r, i, o), r.$$parserName = "number", r.$parsers.push(function (t) {
					return r.$isEmpty(t) ? null : zi.test(t) ? parseFloat(t) : void 0
					...
					n.$observe("min", function (t) {
						v(t) && !w(t) && (t = parseFloat(t)),
						a = w(t) && !isNaN(t) ? t : void 0,
						r.$validate()
					})
				}
			if (v(n.max) || n.ngMax) {
			...
			return {
				...
				link : {
					pre : function (i, o, a, s) {
						s[0] && (Xi[Kn(a.type)] || Xi.text)(i, o, a, s[0], e, t, n, r)
					}
				}
			}
		}
	...
	eo = function () {
		return {
			...
			priority : 100,
			compile : function (t, e) {
				return to.test(e.ngValue) ? function (t, e, n) {
	...
	ro = ["$interpolate", "$compile", function (t, e) {
			return {
				compile : function (n) {
					...
					function (n, r, i) {
						n = t(r.attr(i.$attr.ngBindTemplate)),
						e.$$addBindingInfo(r, n.expressions),
						r = r[0],
	...
	io = ["$sce", "$parse", "$compile", function (t, e, n) {
			return {
				restrict : "A",
					...
					compile : function (i, o) {
						...
						return function (e, n) {
							n.on(t, function (n) {
								...
								ho[t] && r.$$phase ? e.$evalAsync(i) : e.$apply(i)
							})
						}
					}
				}
	...
	var po = ["$animate", "$compile", function (t, e) {
			return {
				multiElement : !0,
				transclude : "element",
				priority : 600,
	...
	$o = ["$templateRequest", "$anchorScroll", "$animate", function (t, e, n) {
			return {
				restrict : "ECA",
				priority : 400,
				terminal : !0,
	...
	mo = ["$compile", function (e) {
			return {
				...
				link : function (n, r, i, o) {
					er.call(r[0]).match(/SVG/) ? (r.empty(), e(ht(o.template, t.document).childNodes)(n, function (t) {
							r.append(t)
						}, {
	...
	So = "ng-pending",
	Co = e("ngModel"),
	Eo = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function (t, e, n, i, o, a, s, u, c, l) {
			...
			this.$$setOptions = function (t) {
				if ((b.$options = t) && t.getterSetter) {
					...
					throw Co("nonassign", n.ngModel, L(i))
			},
			this.$render = h,
			...
			this.$setUntouched = function () {
				b.$touched = !1,
				b.$untouched = !0,
				a.setClass(i, "ng-untouched", "ng-touched")
			},
			this.$setTouched = function () {
				b.$touched = !0,
				b.$untouched = !1,
				a.setClass(i, "ng-touched", "ng-untouched")
			},
			...
			this.$validate = function () {
				if (!w(b.$modelValue) || !isNaN(b.$modelValue)) {
					var t = b.$$rawModelValue,
					e = b.$valid,
					n = b.$modelValue,
					r = b.$options && b.$options.allowInvalid;
			...
			this.$$runValidators = function (t, e, n) {
				...
				(function () {
					...
					return m(f) ? (a(t, null), !0) : (f || (r(b.$validators, function (t, e) {
								a(e, null)
			...
			this.$commitViewValue = function () {
				var t = b.$viewValue;
				s.cancel(y),
				(b.$$lastCommittedViewValue !== t || "" === t && b.$$hasNativeValidators) && (b.$$updateEmptyClasses(t), b.$$lastCommittedViewValue = t, b.$pristine && this.$setDirty(), this.$$parseAndValidate())
			},
			this.$$parseAndValidate = function () {
				var e = b.$$lastCommittedViewValue;
				if (f = !m(e) || void 0)
					for (var n = 0; n < b.$parsers.length; n++)
						if (e = b.$parsers[n](e), m(e)) {
							f = !1;
							break
						}
				...
				b.$$rawModelValue = e,
				i && (b.$modelValue = e, b.$modelValue !== r && b.$$writeModelToScope()),
				b.$$runValidators(e, b.$$lastCommittedViewValue, function (t) {
					i || (b.$modelValue = t ? e : void 0, b.$modelValue !== r && b.$$writeModelToScope())
				})
			},
			this.$$writeModelToScope = function () {
				g(t, b.$modelValue),
				r(b.$viewChangeListeners, function (t) {
					try {
						t()
					} catch (n) {
						e(n)
			...
			this.$setViewValue = function (t, e) {
				b.$viewValue = t,
				b.$options && !b.$options.updateOnDefault || b.$$debounceViewValueCommit(e)
			},
			this.$$debounceViewValueCommit = function (e) {
				var n = 0,
				r = b.$options;
				r && v(r.debounce) && (r = r.debounce, w(r) ? n = r : w(r[e]) ? n = r[e] : w(r["default"]) && (n = r["default"])),
				s.cancel(y),
				n ? y = s(function () {
						b.$commitViewValue()
			...
			t.$watch(function () {
				...
				if (e !== b.$modelValue && (b.$modelValue === b.$modelValue || e === e)) {
					...
					f = void 0;
					for (var n = b.$formatters, r = n.length, i = e; r--; )
						i = n[r](i);
					b.$viewValue !== i && (b.$$updateEmptyClasses(i), b.$viewValue = b.$$lastCommittedViewValue = i, b.$render(), b.$$runValidators(e, i, h))
				}
				return e
			})
		}
	],
	ko = ["$rootScope", function (t) {
			return {
				restrict : "A",
				...
				priority : 1,
				compile : function (e) {
					return e.addClass(wo).addClass("ng-untouched").addClass(yo), {
	...
	Oo = function () {
		return {
			...
			controller : ["$scope", "$attrs", function (t, e) {
					var n = this;
					this.$options = j(t.$eval(e.ngModelOptions)),
					v(this.$options.updateOn) ? (this.$options.updateOnDefault = !1, this.$options.updateOn = ur(this.$options.updateOn.replace(Ao, function () {
	...
	No = e("ngOptions"),
	To = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,
	Vo = ["$compile", "$document", "$parse", function (e, i, o) {
			function a(t, e, r) {
				...
				function a(t) {
					...
					if (!c && n(t))
						...
						e = [];
						for (var r in t)
							t.hasOwnProperty(r) && "$" !== r.charAt(0) && e.push(r)
					}
					return e
				}
				var s = t.match(To);
				...
				return {
					...
					getWatchables : o(g, function (t) {
						...
						for (var n = a(t), i = n.length, o = 0; o < i; o++) {
							...
							c = p(c, u);
							e.push(c),
							(s[2] || s[1]) && (c = $(r, u), e.push(c)),
							s[4] && (u = v(r, u), e.push(u))
						}
						return e
					}),
					getOptions : function () {
						...
						return {
							...
							getViewValueFromOption : function (t) {
								return l ? ir.copy(t.viewValue) : t.viewValue
							}
						}
					}
				}
			...
			u = t.document.createElement("optgroup");
			return {
				restrict : "A",
				terminal : !0,
				...
				link : {
					...
					post : function (t, n, o, c) {
						function l(t, e) {
							...
							t.value !== e.value && (e.value = t.selectValue)
						}
						function f() {
							var t = w && p.readValue();
							if (w)
								for (var e = w.items.length - 1; 0 <= e; e--) {
									var r = w.items[e];
									Ot(v(r.group) ? r.element.parentNode : r.element)
								}
							w = x.getOptions();
							var i = {};
							y && n.prepend(h),
							w.items.forEach(function (t) {
								...
								if (v(t.group)) {
									e = i[t.group],
									e || (e = u.cloneNode(!1), S.appendChild(e), e.label = null === t.group ? "null" : t.group, i[t.group] = e);
									var n = s.cloneNode(!1)
								} else
									e = S, n = s.cloneNode(!1);
								e.appendChild(n),
							...
							n[0].appendChild(S),
							d.$render(),
							d.$isEmpty(t) || (e = p.readValue(), (x.trackBy || $ ? I(t, e) : t === e) || (d.$setViewValue(e), d.$render()))
						}
						var h,
						p = c[0],
						d = c[1],
						$ = o.multiple;
						c = 0;
						for (var m = n.children(), g = m.length; c < g; c++)
							if ("" === m[c].value) {
								h = m.eq(c);
								break
							}
						...
						$ ? (d.$isEmpty = function (t) {
							...
							e
								...
								if (ar(d.$viewValue))
									return d.$viewValue.map(function (t) {
										return x.getTrackByValue(t)
									})
							}, function () {
								d.$render()
							})) : (p.writeValue = function (t) {
							var e = w.getOptionFromViewValue(t);
							e ? (n[0].value !== e.selectValue && (b.remove(), y || h.remove(), n[0].value = e.selectValue, e.element.selected = !0), e.element.setAttribute("selected", "selected")) : null === t || y ? (b.remove(), y || n.prepend(h), n.val(""), h.prop("selected", !0), h.attr("selected", !0)) : (y || h.remove(), n.prepend(b), n.val("?"), b.prop("selected", !0), b.attr("selected", !0))
						}, p.readValue = function () {
							var t = w.selectValueMap[n.val()];
							return t && !t.disabled ? (y || h.remove(), b.remove(), w.getViewValueFromOption(t)) : null
						}, x.trackBy && t.$watch(function () {
								return x.getTrackByValue(d.$viewValue)
							}, function () {
								d.$render()
							})),
						y ? (h.remove(), e(h)(t), h.removeClass("ng-scope")) : h = zn(s.cloneNode(!1)),
						n.empty(),
						f(),
						t.$watchCollection(x.getWatchables, f)
					}
				}
			}
		}
	],
	jo = ["$locale", "$interpolate", "$log", function (t, e, n) {
			var i = /{}/g,
			o = /^when(Minus)?(.+)$/;
			return {
				link : function (a, s, u) {
					...
					r(u, function (t, e) {
						var n = o.exec(e);
						n && (n = (n[1] ? "-" : "") + Kn(n[2]), $[n] = s.attr(u.$attr[e]))
					}),
					r($, function (t, n) {
						v[n] = e(t.replace(i, b))
					}),
					a.$watch(f, function (e) {
						var r = parseFloat(e),
						i = isNaN(r);
						i || r in $ || (r = t.pluralCat(r - d)),
						r === l || i && w(l) && isNaN(l) || (x(), i = v[r], m(i) ? (null != e && n.debug("ngPluralize: no rule defined for '" + r + "' in " + p), x = h, c()) : x = a.$watch(i, c), l = r)
					})
				}
			}
		}
	],
	Io = ["$parse", "$animate", "$compile", function (t, i, o) {
			var a = e("ngRepeat"),
			...
			return {
				...
				compile : function (e, u) {
					...
					var m = f[3] || f[1],
					v = f[2];
					if (d && (!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(d) || /^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(d)))
						throw a("badident", d);
					var g,
					y,
					b,
					...
					function (t, e, o, u, f) {
						...
						t.$watchCollection(p, function (o) {
							...
							if (d && (t[d] = o), n(o))
								...
								for (A in p = y || w, E = [], o)
									Jn.call(o, A) && "$" !== A.charAt(0) && E.push(A);
							for (g = E.length, A = Array(g), u = 0; u < g; u++)
								if (x = o === E ? u : E[u], S = o[x], C = p(x, S, u), h[C])
									k = h[C], delete h[C], M[C] = k, A[u] = k;
								else {
									if (M[C])
										throw r(A, function (t) {
											t && t.scope && (h[t.id] = t)
										}), a("dupes", c, C, S);
									A[u] = {
										id : C,
							...
							for ($ in h) {
								if (k = h[$], C = ot(k.clone), i.leave(C), C[0].parentNode)
									for (u = 0, p = C.length; u < p; u++)
										C[u].$$NG_REMOVED = !0;
								k.scope.$destroy()
							}
							for (u = 0; u < g; u++)
								if (x = o === E ? u : E[u], S = o[x], k = A[u], k.scope) {
									$ = O;
									do
										$ = $.nextSibling;
									while ($ && $.$$NG_REMOVED);
									k.clone[0] != $ && i.move(ot(k.clone), null, O),
									O = k.clone[k.clone.length - 1],
									s(k.scope, u, m, S, v, x, g)
								} else
									f(function (t, e) {
										k.scope = e;
										var n = l.cloneNode(!1);
	...
	Fo = ["$animate", "$compile", function (t, e) {
			return {
				require : "ngSwitch",
				...
				link : function (n, i, o, a) {
					...
					n.$watch(o.ngSwitch || o.on, function (n) {
						...
						for (i = c.length = 0, o = l.length; i < o; ++i) {
							var h = ot(u[i].clone);
							l[i].$destroy(),
							(c[i] = t.leave(h)).then(f(c, i))
						}
						u.length = 0,
						l.length = 0,
						(s = a.cases["!" + n] || a.cases["?"]) && r(s, function (n) {
			...
			return {
				...
				compile : function (e) {
					...
					function (t, e, r, i, o) {
						...
						r && !o.isSlotFilled(r) && a()
					}
				}
			}
		}
	],
	Bo = ["$templateCache", function (t) {
			return {
				restrict : "E",
				terminal : !0,
	...
	zo = ["$element", "$scope", function (e, n) {
			var r = this,
			i = new Pt;
			r.ngModelCtrl = Ho,
			r.unknownOption = zn(t.document.createElement("option")),
			r.renderUnknownOption = function (t) {
				t = "? " + Dt(t) + " ?",
				r.unknownOption.val(t),
				...
				pre : function (t, e, n, i) {
					...
					if (o) {
						...
						if (a.ngModelCtrl = o, e.on("change", function () {
							...
							u = NaN;
							t.$watch(function () {
								u !== o.$viewValue || I(s, o.$viewValue) || (s = ut(o.$viewValue), o.$render()),
								u = o.$viewValue
							}),
	...
	Ko = function () {
		return {
			...
			link : function (t, n, r, i) {
				if (i) {
					var o,
					a = r.ngPattern || r.pattern;
					r.$observe("pattern", function (t) {
						if (b(t) && 0 < t.length && (t = new RegExp("^" + t + "$")), t && !t.test)
							throw e("ngPattern")("noregexp", a, t, L(n));
						o = t || void 0,
						i.$validate()
					}),
	...
	t.angular.bootstrap ? t.console && console.log("WARNING: Tried to load angular more than once.") : (tt(), ct(ir), ir.module("ngLocale", [], ["$provide", function (t) {
					function e(t) {
						t += "";
						var e = t.indexOf(".");
					...
					t.value("$locale", {
						...
						pluralCat : function (t, n) {
							var r = 0 | t,
							i = n;
							return void 0 === i && (i = Math.min(e(t), 3)),
							Math.pow(10, i),
							1 == r && 0 == i ? "one" : "other"
						}
					})
...
angular.module("ui.bootstrap", ["ui.bootstrap.tpls", "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.buttons", "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.isClass", "ui.bootstrap.position", "ui.bootstrap.datepicker", "ui.bootstrap.debounce", "ui.bootstrap.dropdown", "ui.bootstrap.stackedMap", "ui.bootstrap.modal", "ui.bootstrap.paging", "ui.bootstrap.pager", "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating", "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"]), angular.module("ui.bootstrap.tpls", ["uib/template/accordion/accordion-group.html", "uib/template/accordion/accordion.html", "uib/template/alert/alert.html", "uib/template/carousel/carousel.html", "uib/template/carousel/slide.html", "uib/template/datepicker/datepicker.html", "uib/template/datepicker/day.html", "uib/template/datepicker/month.html", "uib/template/datepicker/popup.html", "uib/template/datepicker/year.html", "uib/template/modal/backdrop.html", "uib/template/modal/window.html", "uib/template/pager/pager.html", "uib/template/pagination/pagination.html", "uib/template/tooltip/tooltip-html-popup.html", "uib/template/tooltip/tooltip-popup.html", "uib/template/tooltip/tooltip-template-popup.html", "uib/template/popover/popover-html.html", "uib/template/popover/popover-template.html", "uib/template/popover/popover.html", "uib/template/progressbar/bar.html", "uib/template/progressbar/progress.html", "uib/template/progressbar/progressbar.html", "uib/template/rating/rating.html", "uib/template/tabs/tab.html", "uib/template/tabs/tabset.html", "uib/template/timepicker/timepicker.html", "uib/template/typeahead/typeahead-match.html", "uib/template/typeahead/typeahead-popup.html"]), angular.module("ui.bootstrap.collapse", []).directive("uibCollapse", ["$animate", "$injector", function (e, t) {
			...
			return {
				link : function (t, a, i) {
					function o() {
						a.removeClass("collapse").addClass("collapsing").attr("aria-expanded", !0).attr("aria-hidden", !1),
						n ? n(a, {
							addClass : "in",
							easing : "ease",
							to : {
						...
						}).start()["finally"](r) : e.addClass(a, "in", {
							to : {
								height : a[0].scrollHeight + "px"
							}
						}).then(r)
					...
					function l() {
						return a.hasClass("collapse") || a.hasClass("in") ? (a.css({
								height : a[0].scrollHeight + "px"
							}).removeClass("collapse").addClass("collapsing").attr("aria-expanded", !1).attr("aria-hidden", !0), void(n ? n(a, {
									removeClass : "in",
									to : {
										height : "0"
									}
								}).start()["finally"](s) : e.removeClass(a, "in", {
									to : {
										height : "0"
									}
								}).then(s))) : s()
					...
					t.$eval(i.uibCollapse) || a.addClass("in").addClass("collapse").css({
						height : "auto"
					}),
					t.$watch(i.uibCollapse, function (e) {
						e ? l() : o()
					})
				}
			}
					...
					n.on(o.toggleEvent, function () {
						if (!a.disabled) {
							...
							(!e || angular.isDefined(a.uncheckable)) && t.$apply(function () {
								r.$setViewValue(e ? null : t.$eval(a.uibBtnRadio)),
								r.$render()
							})
						}
					}),
		...
		link : function (e, t, n, a) {
			...
			t.on(l.toggleEvent, function () {
				n.disabled || e.$apply(function () {
					s.$setViewValue(t.hasClass(l.activeClass) ? o() : i()),
					s.$render()
				})
			})
		}
				...
				$ || (angular.extend(n, {
						...
						active : !1
							...
							if ("close" === n && (e.$currentTransition = null, i.off("addClass", t), v.length)) {
								var a = v.pop(),
								r = e.indexOfSlide(a),
								s = r > f.getCurrentIndex() ? "next" : "prev";
								o(),
								l(a, r, s)
							}
			...
			f.addSlide = function (t, n) {
				t.$element = n,
				h.push(t),
				1 === h.length || t.active ? (e.$currentTransition && (e.$currentTransition = null), f.select(h[h.length - 1]), 1 === h.length && e.play()) : t.active = !1
			},
			...
			f.select = e.select = function (t, n) {
				...
				void 0 === n && (n = a > f.getCurrentIndex() ? "next" : "prev"),
				t && t !== f.currentSlide && !e.$currentTransition ? l(t, a, n) : t && t !== f.currentSlide && e.$currentTransition && (v.push(t), t.active = !1)
			},
	...
	return {
		...
		link : function (e, t, n, a) {
			...
			function a(e) {
				...
				if (i > -1) {
					...
					for (var r = i; r < e.length; r++)
						o ? ("'" === e[r] && (r + 1 < e.length && "'" === e[r + 1] ? (e[r + 1] = "$", a[r + 1] = "") : (a[r] = "", o = !1)), e[r] = "$") : "'" === e[r] && (e[r] = "$", a[r] = "", o = !0);
					e = e.join("")
				}
				return angular.forEach(d, function (n) {
					...
					if (i > -1) {
						...
						a[i] = "(" + n.regex + ")",
						e[i] = "$";
						for (var o = i + 1, r = i + n.key.length; r > o; o++)
							a[o] = "", e[o] = "$";
						e = e.join(""),
						t.push({
							index : i,
			...
			this.init(),
			this.parse = function (n, o, r) {
				if (!angular.isString(n) || !o)
					return n;
				o = t.DATETIME_FORMATS[o] || o,
				o = o.replace(m, "\\$&"),
				t.id !== p && this.init(),
				this.parsers[o] || (this.parsers[o] = a(o));
				var l = this.parsers[o],
				s = l.regex,
				u = l.map,
				c = n.match(s),
				d = !1;
				if (c && c.length) {
					...
					for (var g = 1, b = c.length; b > g; g++) {
						var v = u[g - 1];
						"Z" === v.matcher && (d = !0),
						v.apply && v.apply.call(f, c[g])
					}
					var $ = d ? Date.prototype.setUTCFullYear : Date.prototype.setFullYear,
					y = d ? Date.prototype.setUTCHours : Date.prototype.setHours;
					return i(f.year, f.month, f.date) && (!angular.isDate(r) || isNaN(r.getTime()) || d ? (h = new Date(0), $.call(h, f.year, f.month, f.date), y.call(h, f.hours || 0, f.minutes || 0, f.seconds || 0, f.milliseconds || 0)) : (h = new Date(r), $.call(h, f.year, f.month, f.date), y.call(h, f.hours, f.minutes, f.seconds, f.milliseconds))),
					h
				}
			},
			this.toTimezone = r,
			this.fromTimezone = l,
			this.timezoneToOffset = s,
			this.addDateMinutes = u,
			this.convertTimezoneToLocal = c
		}
			...
			return {
				...
				offsetParent : function (n) {
					...
					n = this.getRawNode(n);
					for (var i = n.offsetParent || e[0].documentElement; i && i !== e[0].documentElement && a(i); )
						i = i.offsetParent;
				...
				scrollParent : function (n, i) {
					n = this.getRawNode(n);
					var o = i ? a.hidden : a.normal,
					r = e[0].documentElement,
					l = t.getComputedStyle(n),
					s = "absolute" === l.position,
					u = n.parentElement || r;
					if (u === r || "fixed" === l.position)
						return r;
					for (; u.parentElement && u !== r; ) {
						var c = t.getComputedStyle(u);
						if (s && "static" !== c.position && (s = !1), !s && o.test(c.overflow + c.overflowY + c.overflowX))
							break;
						u = u.parentElement
					}
					return u
				...
				position : function (n, a) {
					...
					if (a) {
						...
						i.top -= this.parseStyle(o.marginTop),
						i.left -= this.parseStyle(o.marginLeft)
					}
				...
				viewportOffset : function (n, a, i) {
					...
					l = a ? e[0].documentElement : this.scrollParent(n),
					...
					if (r.top = s.top + l.clientTop, r.left = s.left + l.clientLeft, l === e[0].documentElement && (r.top += t.pageYOffset, r.left += t.pageXOffset), r.bottom = r.top + l.clientHeight, r.right = r.left + l.clientWidth, i) {
						...
						r.top += this.parseStyle(u.paddingTop),
						r.bottom -= this.parseStyle(u.paddingBottom),
						r.left += this.parseStyle(u.paddingLeft),
						r.right -= this.parseStyle(u.paddingRight)
					}
					return {
				...
				parsePlacement : function (e) {
					var t = i.auto.test(e);
					return t && (e = e.replace(i.auto, "")),
					e = e.split("-"),
					e[0] = e[0] || "top",
					i.primary.test(e[0]) || (e[0] = "top"),
					e[1] = e[1] || "center",
					i.secondary.test(e[1]) || (e[1] = "center"),
					t ? e[2] = !0 : e[2] = !1,
					e
				},
				positionElements : function (e, n, a, o) {
					...
					if (a[2]) {
						...
						if (a[0] = "top" === a[0] && d.height > c.top && d.height <= c.bottom ? "bottom" : "bottom" === a[0] && d.height > c.bottom && d.height <= c.top ? "top" : "left" === a[0] && d.width > c.left && d.width <= c.right ? "right" : "right" === a[0] && d.width > c.right && d.width <= c.left ? "left" : a[0], a[1] = "top" === a[1] && d.height - s.height > c.bottom && d.height - s.height <= c.top ? "bottom" : "bottom" === a[1] && d.height - s.height > c.top && d.height - s.height <= c.bottom ? "top" : "left" === a[1] && d.width - s.width > c.right && d.width - s.width <= c.left ? "right" : "right" === a[1] && d.width - s.width > c.left && d.width - s.width <= c.right ? "left" : a[1], "center" === a[1])
							if (i.vertical.test(a[0])) {
								var m = s.width / 2 - r / 2;
					...
					return u.top = Math.round(u.top),
					u.left = Math.round(u.left),
					u.placement = "center" === a[1] ? a[0] : a[0] + "-" + a[1],
					u
				},
				positionArrow : function (e, n) {
					e = this.getRawNode(e);
					var a = !0,
					o = e.querySelector(".tooltip-inner");
					if (o || (a = !1, o = e.querySelector(".popover-inner")), o) {
						var r = a ? e.querySelector(".tooltip-arrow") : e.querySelector(".arrow");
						if (r) {
							if (n = this.parsePlacement(n), "center" === n[1])
								return void angular.element(r).css({
									top : "",
									bottom : "",
									right : "",
									left : "",
							...
							s = t.getComputedStyle(r)[l],
							u = "border-";
							u += i.vertical.test(n[0]) ? n[0] + "-" + n[1] : n[1] + "-" + n[0],
							u += "-radius";
	...
	ngModelOptions : {}
			...
			angular.forEach(["minDate", "maxDate"], function (n) {
				t[n] ? e.$parent.$watch(t[n], function (e) {
					u[n] = e ? angular.isDate(e) ? s.fromTimezone(new Date(e), p.timezone) : new Date(o(e, "medium")) : null,
					u.refreshView()
			...
			angular.forEach(["minMode", "maxMode"], function (n) {
				t[n] ? e.$parent.$watch(t[n], function (a) {
					u[n] = e[n] = angular.isDefined(a) ? a : t[n],
					("minMode" === n && u.modes.indexOf(e.datepickerMode) < u.modes.indexOf(u[n]) || "maxMode" === n && u.modes.indexOf(e.datepickerMode) > u.modes.indexOf(u[n])) && (e.datepickerMode = u[n])
				}) : u[n] = e[n] = r[n] || null
			}),
			e.datepickerMode = e.datepickerMode || r.datepickerMode,
			e.uniqueId = "datepicker-" + e.$id + "-" + Math.floor(1e4 * Math.random()),
			angular.isDefined(t.initDate) ? (this.activeDate = s.fromTimezone(e.$parent.$eval(t.initDate), p.timezone) || new Date, e.$parent.$watch(t.initDate, function (e) {
			...
			angular.isDefined(t.ngDisabled) && e.$parent.$watch(t.ngDisabled, function (t) {
				e.disabled = t,
				u.refreshView()
			}),
			...
			this.init = function (e) {
				c = e,
				p = e.$options || r.ngModelOptions,
				c.$modelValue && (this.activeDate = c.$modelValue),
				c.$render = function () {
					u.render()
				}
			},
			...
			this.refreshView = function () {
				if (this.element) {
					...
					t = s.fromTimezone(t, p.timezone),
					c.$setValidity("dateDisabled", !t || this.element && !this.isDisabled(t))
				}
			},
			this.createDateObject = function (t, n) {
				...
				return a && 0 === this.compare(t, a) && (e.selectedDt = i),
				u.activeDate && 0 === this.compare(i.date, u.activeDate) && (e.activeDt = i),
				i
			},
			...
			e.select = function (t) {
				if (e.datepickerMode === u.minMode) {
					...
					n = s.toTimezone(n, p.timezone),
					c.$setViewValue(n),
					c.$render()
				} else
					u.activeDate = t, e.datepickerMode = u.modes[u.modes.indexOf(e.datepickerMode) - 1]
			},
			e.move = function (e) {
				var t = u.activeDate.getFullYear() + e * (u.step.years || 0),
				n = u.activeDate.getMonth() + e * (u.step.months || 0);
				u.activeDate.setFullYear(t, n, 1),
				u.refreshView()
			},
			e.toggleMode = function (t) {
				t = t || 1,
				e.datepickerMode === u.maxMode && 1 === t || e.datepickerMode === u.minMode && -1 === t || (e.datepickerMode = u.modes[u.modes.indexOf(e.datepickerMode) + t])
			},
			e.keys = {
				13 : "enter",
				32 : "space",
			...
			this.getDates = function (e, t) {
				for (var n, a = new Array(t), i = new Date(e), o = 0; t > o; )
					n = new Date(i), a[o++] = n, i.setDate(i.getDate() + 1);
				return a
			},
			this._refreshView = function () {
				...
				s = new Date(o);
				l > 0 && s.setDate(-l + 1);
				for (var u = this.getDates(s, 42), c = 0; 42 > c; c++)
					u[c] = angular.extend(this.createDateObject(u[c], this.formatDay), {
				...
				for (var p = 0; 7 > p; p++)
					e.labels[p] = {
						abbr : n(u[p].date, this.formatDayHeader),
						full : n(u[p].date, "EEEE")
					};
				if (e.title = n(this.activeDate, this.formatDayTitle), e.rows = this.split(u, 7), e.showWeeks) {
					e.weekNumbers = [];
					for (var d = (11 - this.startingDay) % 7, m = e.rows.length, f = 0; m > f; f++)
						e.weekNumbers.push(i(e.rows[f][d].date))
				}
			},
			...
			this.handleKeyDown = function (e, t) {
				...
				if ("left" === e)
					...
					n = Math.min(a(this.activeDate.getFullYear(), this.activeDate.getMonth()), n)
				} else
					"home" === e ? n = 1 : "end" === e && (n = a(this.activeDate.getFullYear(), this.activeDate.getMonth()));
			...
			this._refreshView = function () {
				for (var t, a = new Array(12), i = this.activeDate.getFullYear(), o = 0; 12 > o; o++)
					t = new Date(this.activeDate), t.setFullYear(i, o, 1), a[o] = angular.extend(this.createDateObject(t, this.formatMonth), {
							uid : e.uniqueId + "-" + o
						});
				e.title = n(this.activeDate, this.formatMonthTitle),
				e.rows = this.split(a, 3)
			},
			this.compare = function (e, t) {
			...
			this._refreshView = function () {
				for (var t, n = new Array(o), r = 0, l = a(this.activeDate.getFullYear()); o > r; r++)
					t = new Date(this.activeDate), t.setFullYear(l + r, 0, 1), n[r] = angular.extend(this.createDateObject(t, this.formatYear), {
							uid : e.uniqueId + "-" + r
						});
				e.title = [n[0].label, n[o - 1].label].join(" - "),
			...
			this.handleKeyDown = function (e, t) {
				...
				"left" === e ? n -= 1 : "up" === e ? n -= i : "right" === e ? n += 1 : "down" === e ? n += i : "pageup" === e || "pagedown" === e ? n += ("pageup" === e ? -1 : 1) * o : "home" === e ? n = a(this.activeDate.getFullYear()) : "end" === e && (n = a(this.activeDate.getFullYear()) + o - 1),
	...
	altInputFormats : []
			...
			function f(t) {
				...
				if (isNaN(n))
					for (var a = 0; a < P.length; a++)
						if (n = u.parse(t, P[a], e.date), !isNaN(n))
							return n;
				return n
			}
			function h(e) {
				...
				if (angular.isString(e)) {
					var t = f(e);
					if (!isNaN(t))
						return u.toTimezone(t, O.timezone)
				}
			...
			function b(n) {
				if (e.isOpen || !e.disabled) {
					...
					o = void 0 !== a.contains && a.contains(n.target);
			...
			this.init = function (l) {
				if (T = l, O = l.$options || d.ngModelOptions, y = angular.isDefined(n.closeOnDateSelection) ? e.$parent.$eval(n.closeOnDateSelection) : c.closeOnDateSelection, w = angular.isDefined(n.datepickerAppendToBody) ? e.$parent.$eval(n.datepickerAppendToBody) : c.appendToBody, k = angular.isDefined(n.onOpenFocus) ? e.$parent.$eval(n.onOpenFocus) : c.onOpenFocus, D = angular.isDefined(n.datepickerPopupTemplateUrl) ? n.datepickerPopupTemplateUrl : c.datepickerPopupTemplateUrl, x = angular.isDefined(n.datepickerTemplateUrl) ? n.datepickerTemplateUrl : c.datepickerTemplateUrl, P = angular.isDefined(n.altInputFormats) ? e.$parent.$eval(n.altInputFormats) : c.altInputFormats, e.showButtonBar = angular.isDefined(n.showButtonBar) ? e.$parent.$eval(n.showButtonBar) : c.showButtonBar, c.html5Types[n.type] ? ($ = c.html5Types[n.type], I = !0) : ($ = n.uibDatepickerPopup || c.datepickerPopup, n.$observe("uibDatepickerPopup", function (e, t) {
							...
							if (n !== $ && ($ = n, T.$modelValue = null, !$))
								throw new Error("uibDatepickerPopup must have a date format specified.")
							})), !$)throw new Error("uibDatepickerPopup must have a date format specified.");
				if (I && n.uibDatepickerPopup)
				...
				if (C = angular.element("<div uib-datepicker-popup-wrap><div uib-datepicker></div></div>"), e.ngModelOptions = angular.copy(O), e.ngModelOptions.timezone = null, C.attr({
					...
					p && p.initDate && (e.initDate = u.fromTimezone(p.initDate, O.timezone), M.attr("init-date", "initDate"), delete p.initDate),
					angular.forEach(p, function (e, t) {
						M.attr(m(t), e)
					})
				}
				...
				angular.forEach(["minDate", "maxDate", "initDate"], function (t) {
					if (n[t]) {
						...
						e.$parent.$watch(a, function (n) {
							("minDate" === t || "maxDate" === t) && (E[t] = angular.isDate(n) ? u.fromTimezone(new Date(n), O.timezone) : new Date(s(n, "medium"))),
							e.watchData[t] = E[t] || u.fromTimezone(new Date(n), O.timezone)
						}),
						M.attr(m(t), "watchData." + t)
					}
				}),
				n.dateDisabled && M.attr("date-disabled", "dateDisabled({ date: date, mode: mode })"),
				angular.forEach(["formatDay", "formatMonth", "formatYear", "formatDayHeader", "formatDayTitle", "formatMonthTitle", "showWeeks", "startingDay", "yearRows", "yearColumns"], function (e) {
					angular.isDefined(n[e]) && M.attr(m(e), n[e])
				}),
				n.customClass && M.attr("custom-class", "customClass({ date: date, mode: mode })"),
				I ? T.$formatters.push(function (t) {
					return e.date = u.fromTimezone(t, O.timezone),
					t
				...
				S = a(C)(e),
				C.remove(),
				w ? o.find("body").append(S) : t.after(S),
				e.$on("$destroy", function () {
			...
			e.isDisabled = function (t) {
				...
				e.watchData.minDate && e.compare(t, E.minDate) < 0 || e.watchData.maxDate && e.compare(t, E.maxDate) > 0
			},
			...
			n.ngDisabled && e.$parent.$watch(i(n.ngDisabled), function (t) {
				e.disabled = t
			}),
			e.$watch("isOpen", function (n) {
				n ? e.disabled ? e.isOpen = !1 : (e.position = w ? l.offset(t) : l.position(t), e.position.top = e.position.top + t.prop("offsetHeight"), p(function () {
							k && e.$broadcast("uib:datepicker.focus"),
							o.bind("click", b)
	...
	openClass : "open"
			...
			m = this,
			f = e.$new(),
			h = i.appendToOpenClass,
			g = i.openClass,
			b = angular.noop,
			v = n.onToggle ? a(n.onToggle) : angular.noop,
			$ = !1,
			y = null,
			w = !1,
			k = s.find("body");
			...
			this.init = function () {
				...
				$ = angular.isDefined(n.dropdownAppendToBody),
				w = angular.isDefined(n.keyboardNav),
				$ && !y && (y = k),
				y && m.dropdownMenu && (y.append(m.dropdownMenu), t.on("$destroy", function () {
			...
			f.$watch("isOpen", function (n, a) {
				if (y && m.dropdownMenu) {
					var i,
					s,
					d = l.positionElements(t, m.dropdownMenu, "bottom-left", !0);
					if (i = {
							top : d.top + "px",
						...
						var w = l.offset(y);
						i.top = d.top - w.top + "px",
						s ? i.right = window.innerWidth - (d.left - w.left + t.prop("offsetWidth")) + "px" : i.left = d.left - w.left + "px"
					}
					m.dropdownMenu.css(i)
				}
				var k = y ? y : t;
				if (r[n ? "addClass" : "removeClass"](k, y ? h : g).then(function () {
						angular.isDefined(n) && n !== a && v(e, {
							open : !!n
						})
					}), n)
					m.dropdownMenuTemplateUrl && c(m.dropdownMenuTemplateUrl).then(function (e) {
						p = f.$new(),
	...
	this.$get = ["$injector", "$q", function (t, n) {
			...
			function a(t, a, i) {
				i.modalInClass && (e(a, {
					...
					}).start(), t.$on(n.NOW_CLOSING_EVENT, function (n, o) {
						var r = o();
						t.modalOptions.animation ? e(a, {
			...
			return {
				...
				link : function (o, r, l) {
					r.addClass(l.windowClass || ""),
					r.addClass(l.windowTopClass || ""),
					o.size = l.size,
					o.close = function (t) {
						var n = e.getTop();
	...
	return {
		link : function (e, t, n, a, i) {
			...
			function s() {
				for (var e = -1, t = $.keys(), n = 0; n < t.length; n++)
					$.get(t[n]).value.backdrop && (e = n);
				return e
			}
			function u(e, t) {
				var n = $.get(e).value,
				a = n.appendTo;
				$.remove(e),
				d(n.modalDomEl, n.modalScope, function () {
					var t = n.openedClass || v;
					y.remove(t, e),
					a.toggleClass(t, y.hasKey(t)),
					c(!0)
				}),
				p(),
				t && t.focus ? t.focus() : a.focus && a.focus()
			}
			function c(e) {
				var t;
			...
			function d(e, n, a, i) {
				...
				s = null,
				u = function () {
					return l || (l = o.defer(), s = l.promise),
					function () {
						l.resolve()
					}
				};
				return n.$broadcast(w.NOW_CLOSING_EVENT, u),
				o.when(s).then(r)
			}
			function m(e) {
			...
			k = 0,
			D = "a[href], area[href], input:not([disabled]), button:not([disabled]),select:not([disabled]), textarea:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable=true]";
			...
			w.open = function (t, o) {
				...
				o.animation && d.attr("modal-animation", "true"),
				e.enter(d, u).then(function () {
					a(d)(o.scope),
					e.addClass(u, l)
				}),
				$.top().value.modalDomEl = d,
				$.top().value.modalOpener = r,
	...
	var e = {
		...
		$get : ["$rootScope", "$q", "$document", "$templateRequest", "$controller", "$uibResolve", "$uibModalStack", function (t, n, a, i, o, r, l) {
				...
				u.open = function (i) {
					...
					if (i = angular.extend({}, e.options, i), i.resolve = i.resolve || {}, i.appendTo = i.appendTo || a.find("body").eq(0), !i.template && !i.templateUrl)
						throw new Error("One of template or templateUrl options is required.");
					var g,
					b = n.all([s(i), r.resolve(i.resolve, {}, null, null)]);
					return g = c = n.all([c]).then(u, u).then(function (e) {
							...
							i.controller && (s.$scope = a, s.$uibModalInstance = h, angular.forEach(e[1], function (e, t) {
									s[t] = e
								}), r = o(i.controller, s), i.controllerAs && (i.bindToController && (r.$close = a.$close, r.$dismiss = a.$dismiss, angular.extend(r, n)), a[i.controllerAs] = r)),
							l.open(h, {
								scope : a,
								deferred : p,
								renderDeferred : f,
	...
	return e
			...
			return {
				create : function (t, n, a) {
					t.setNumPages = a.numPages ? e(a.numPages).assign : angular.noop,
					t.ngModelCtrl = {
						$setViewValue : angular.noop
					},
					t.init = function (i, o) {
						...
						a.itemsPerPage ? n.$parent.$watch(e(a.itemsPerPage), function (e) {
							...
							t.updatePage()
						}) : t.itemsPerPage = o.itemsPerPage,
						n.$watch("totalItems", function (e, a) {
			...
			e.align = angular.isDefined(t.align) ? e.$parent.$eval(t.align) : a.align,
			n.create(this, e, t)
		}
	...
	align : !0
			...
			var l = this,
			s = angular.isDefined(t.maxSize) ? e.$parent.$eval(t.maxSize) : i.maxSize,
			u = angular.isDefined(t.rotate) ? e.$parent.$eval(t.rotate) : i.rotate,
			c = angular.isDefined(t.forceEllipses) ? e.$parent.$eval(t.forceEllipses) : i.forceEllipses,
			p = angular.isDefined(t.boundaryLinkNumbers) ? e.$parent.$eval(t.boundaryLinkNumbers) : i.boundaryLinkNumbers;
			...
			a.create(this, e, t),
			t.maxSize && e.$parent.$watch(n(t.maxSize), function (e) {
				s = parseInt(e, 10),
				l.render()
			});
			var d = this.render;
			this.render = function () {
				d(),
				e.page > 0 && e.page <= e.totalPages && (e.pages = r(e.page, e.totalPages))
			}
		}
	...
	this.$get = ["$window", "$compile", "$timeout", "$document", "$uibPosition", "$interpolate", "$rootScope", "$parse", "$$stackedMap", function (i, o, r, l, s, u, c, p, d) {
			...
			var f = d.createNew();
			return l.on("keypress", m),
			c.$on("$destroy", function () {
				l.off("keypress", m)
			}),
			function (i, c, d, m) {
				function h(e) {
					var t = (e || m.trigger || d).split(" "),
					a = t.map(function (e) {
							return n[e] || e
						});
					return {
				...
				b = u.startSymbol(),
				v = u.endSymbol(),
				$ = "<div " + g + '-popup title="' + b + "title" + v + '" ' + (m.useContentExp ? 'content-exp="contentExp()" ' : 'content="' + b + "content" + v + '" ') + 'placement="' + b + "placement" + v + '" popup-class="' + b + "popupClass" + v + '" animation="animation" is-open="isOpen"origin-scope="origScope" style="visibility: hidden; display: block; top: -9999px; left: -9999px;"></div>';
				return {
					compile : function (e, t) {
						var n = o($);
						return function (e, t, a, o) {
							...
							function g() {
								v(),
								V.popupCloseDelay ? U || (U = r($, V.popupCloseDelay, !1)) : $()
							}
							function b() {
								return v(),
								y(),
								V.content ? (w(), void V.$evalAsync(function () {
										V.isOpen = !0,
										x(!0),
										L()
									})) : angular.noop
							...
							function D() {
								V.title = a[c + "Title"],
								z ? V.content = z(e) : V.content = a[i],
								V.popupClass = a[c + "Class"],
								V.placement = angular.isDefined(a[c + "Placement"]) ? a[c + "Placement"] : m.placement;
								var t = parseInt(a[c + "PopupDelay"], 10),
								n = parseInt(a[c + "PopupCloseDelay"], 10);
								V.popupDelay = isNaN(t) ? m.popupDelay : t,
								V.popupCloseDelay = isNaN(n) ? m.popupCloseDelay : n
							}
							function x(t) {
							...
							function O() {
								...
								B(),
								F = h(e),
								"none" !== F.show && F.show.forEach(function (e, n) {
									"outsideClick" === e ? (t.on("click", u), l.on("click", T)) : e === F.hide[n] ? t.on(e, u) : e && (t.on(e, d), t.on(F.hide[n], g)),
							...
							U,
							A,
							N = !!angular.isDefined(m.appendToBody) && m.appendToBody,
							F = h(void 0),
							H = angular.isDefined(a[c + "Enable"]),
							V = e.$new(!0),
							q = !1,
							R = !!angular.isDefined(a[c + "IsOpen"]) && p(a[c + "IsOpen"]),
							z = !!m.useContentExp && p(a[i]),
							Y = [],
							L = function () {
							...
							var W,
							_ = c + "AppendToBody";
							W = _ in a && void 0 === a[_] || e.$eval(a[_]),
			...
			return {
				link : function (i, o, r) {
					...
					s,
					u,
					c = i.$eval(r.tooltipTemplateTranscludeScope),
					p = 0,
					d = function () {
						s && (s.remove(), s = null),
						l && (l.$destroy(), l = null),
			...
			return {
				...
				link : function (t, n, a) {
					...
					t.animation() && n.addClass(a.tooltipAnimationClass)
				}
			}
		}
	...
	max : 100
			...
			this.addBar = function (t, n, o) {
				i || n.css({
					transition : "none"
				}),
				this.bars.push(t),
				t.max = e.max,
				t.title = o && angular.isDefined(o.title) ? o.title : "progressbar",
	...
	return {
		...
		link : function (e, t, n, a) {
			...
			t.addTab = function (e) {
				n.push(e),
				1 === n.length && e.active !== !1 ? e.active = !0 : e.active ? t.select(e) : e.active = !1
			},
		...
		link : function (e, t, n) {
			...
			return {
				...
				link : function (t, n, a, i, o) {
					...
					t.disabled = !1,
					a.disable && t.$parent.$watch(e(a.disable), function (e) {
						t.disabled = !!e
					}),
					t.select = function () {
	...
	templateUrl : "uib/template/timepicker/timepicker.html"
			...
			function p(e) {
				d(),
				v.$setViewValue(new Date(b)),
				m(e)
			}
			function d() {
				v.$setValidity("time", !0),
				e.invalidHours = !1,
				e.invalidMinutes = !1,
				e.invalidSeconds = !1
			}
			function m(t) {
				if (v.$modelValue) {
					...
					e.hours = null, e.minutes = null, e.seconds = null, e.meridian = $[0]
			}
			function f(e) {
				b = g(b, e),
				p()
			...
			function g(e, t) {
				...
				a = new Date(e);
				return a.setHours(n.getHours(), n.getMinutes(), n.getSeconds()),
				a
			}
			var b = new Date,
			v = {
			...
			$ = angular.isDefined(n.meridians) ? e.$parent.$eval(n.meridians) : r.meridians || o.DATETIME_FORMATS.AMPMS;
			e.tabindex = angular.isDefined(n.tabindex) ? n.tabindex : 0,
			t.removeAttr("tabindex"),
			this.init = function (t, a) {
				v = t,
				v.$render = this.render,
				v.$formatters.unshift(function (e) {
					return e ? new Date(e) : null
				});
				var i = a.eq(0),
				o = a.eq(1),
				l = a.eq(2),
				s = angular.isDefined(n.mousewheel) ? e.$parent.$eval(n.mousewheel) : r.mousewheel;
				s && this.setupMousewheelEvents(i, o, l);
				var u = angular.isDefined(n.arrowkeys) ? e.$parent.$eval(n.arrowkeys) : r.arrowkeys;
				u && this.setupArrowkeyEvents(i, o, l),
				e.readonlyInput = angular.isDefined(n.readonlyInput) ? e.$parent.$eval(n.readonlyInput) : r.readonlyInput,
				this.setupInputEvents(i, o, l)
			};
			var y = r.hourStep;
			...
			e.showSeconds = r.showSeconds,
			n.showSeconds && e.$parent.$watch(a(n.showSeconds), function (t) {
				e.showSeconds = !!t
			}),
			e.showMeridian = r.showMeridian,
			n.showMeridian && e.$parent.$watch(a(n.showMeridian), function (t) {
			...
			this.setupMousewheelEvents = function (t, n, a) {
				...
				t.bind("mousewheel wheel", function (t) {
					x || e.$apply(i(t) ? e.incrementHours() : e.decrementHours()),
					t.preventDefault()
				}),
				n.bind("mousewheel wheel", function (t) {
					x || e.$apply(i(t) ? e.incrementMinutes() : e.decrementMinutes()),
					t.preventDefault()
				}),
				a.bind("mousewheel wheel", function (t) {
					x || e.$apply(i(t) ? e.incrementSeconds() : e.decrementSeconds()),
					t.preventDefault()
				})
			},
			...
			this.setupInputEvents = function (t, n, a) {
				if (e.readonlyInput)
					return e.updateHours = angular.noop, e.updateMinutes = angular.noop, void(e.updateSeconds = angular.noop);
				var i = function (t, n, a) {
					v.$setViewValue(null),
					v.$setValidity("time", !1),
					angular.isDefined(t) && (e.invalidHours = t),
					angular.isDefined(n) && (e.invalidMinutes = n),
					angular.isDefined(a) && (e.invalidSeconds = a)
				};
				e.updateHours = function () {
					var e = l(),
					t = s();
					v.$setDirty(),
					angular.isDefined(e) && angular.isDefined(t) ? (b.setHours(e), b.setMinutes(t), k > b || b > D ? i(!0) : p("h")) : i(!0)
				},
				t.bind("blur", function (t) {
					v.$setTouched(),
					null === e.hours || "" === e.hours ? i(!0) : !e.invalidHours && e.hours < 10 && e.$apply(function () {
						e.hours = c(e.hours)
					})
				}),
				e.updateMinutes = function () {
					...
					t = l();
					v.$setDirty(),
					angular.isDefined(e) && angular.isDefined(t) ? (b.setHours(t), b.setMinutes(e), k > b || b > D ? i(void 0, !0) : p("m")) : i(void 0, !0)
				},
				n.bind("blur", function (t) {
					v.$setTouched(),
					null === e.minutes ? i(void 0, !0) : !e.invalidMinutes && e.minutes < 10 && e.$apply(function () {
				...
				e.updateSeconds = function () {
					var e = u();
					v.$setDirty(),
					angular.isDefined(e) ? (b.setSeconds(e), p("s")) : i(void 0, void 0, !0)
				},
			...
			e.showSpinners = angular.isDefined(n.showSpinners) ? e.$parent.$eval(n.showSpinners) : r.showSpinners,
			...
			function m() {
				q.moveInProgress || (q.moveInProgress = !0, q.$digest()),
				Z()
			}
			function f() {
				q.position = S ? p.offset(t) : p.position(t),
				q.position.top += t.prop("offsetHeight")
			}
			var h,
			g,
			b = [9, 13, 27, 38, 40],
			v = 200,
			$ = e.$eval(n.typeaheadMinLength);
			$ || 0 === $ || ($ = 1);
			...
			var k,
			D,
			x = i(n.typeaheadLoading).assign || angular.noop,
			C = i(n.typeaheadOnSelect),
			M = !!angular.isDefined(n.typeaheadSelectOnBlur) && e.$eval(n.typeaheadSelectOnBlur),
			T = i(n.typeaheadNoResults).assign || angular.noop,
			O = n.typeaheadInputFormatter ? i(n.typeaheadInputFormatter) : void 0,
			S = !!n.typeaheadAppendToBody && e.$eval(n.typeaheadAppendToBody),
			P = n.typeaheadAppendTo ? e.$eval(n.typeaheadAppendTo) : null,
			E = e.$eval(n.typeaheadFocusFirst) !== !1,
			I = !!n.typeaheadSelectOnExact && e.$eval(n.typeaheadSelectOnExact),
			U = i(n.typeaheadIsOpen).assign || angular.noop,
			A = e.$eval(n.typeaheadShowHint) || !1,
			N = i(n.ngModel),
			F = i(n.ngModel + "($$$p)"),
			H = function (t, n) {
				return angular.isFunction(N(e)) && g && g.$options && g.$options.getterSetter ? F(t, {
					$$$p : n
				}) : N.assign(t, n)
			},
			V = d.parse(n.uibTypeahead),
			q = e.$new(),
			...
			K = function (n, a) {
				...
				x(e, !0),
				T(e, !1),
				o.when(V.source(e, i)).then(function (o) {
					var r = n === h.$viewValue;
					if (r && k)
						if (o && o.length > 0) {
							q.activeIdx = E ? 0 : -1,
							...
							for (var l = 0; l < o.length; l++)
								i[V.itemName] = o[l], q.matches.push({
									id : _(l),
			...
			q.select = function (a, i) {
				...
				s = {};
				D = !0,
				s[V.itemName] = l = q.matches[a].model,
				o = V.modelMapper(e, s),
				H(e, o),
				...
				W(),
				q.$eval(n.typeaheadFocusOnSelect) !== !1 && r(function () {
					t[0].focus()
				}, 0, !1)
			},
			t.on("keydown", function (e) {
				if (0 !== q.matches.length && -1 !== b.indexOf(e.which)) {
					if (-1 === q.activeIdx && (9 === e.which || 13 === e.which))
						return W(), void q.$digest();
					e.preventDefault();
					var t;
					switch (e.which) {
					case 9:
					...
					case 27:
						...
						break;
					case 38:
						q.activeIdx = (q.activeIdx > 0 ? q.activeIdx : q.matches.length) - 1,
						q.$digest(),
						t = B.find("li")[q.activeIdx],
						t.parentNode.scrollTop = t.offsetTop;
						break;
					case 40:
						q.activeIdx = (q.activeIdx + 1) % q.matches.length,
						q.$digest(),
						t = B.find("li")[q.activeIdx],
						t.parentNode.scrollTop = t.offsetTop
					}
			...
			t.bind("blur", function (e) {
				...
				!w && h.$error.editable && (h.$viewValue = "", t.val("")),
				k = !1,
				D = !1
			});
			var ee = function (e) {
			...
			e.$on("$destroy", function () {
				l.off("click", ee),
				(S || P) && te.remove(),
				S && (angular.element(s).off("resize", m), l.find("body").off("scroll", m)),
				B.remove(),
				A && Y.remove()
			});
			var te = a(B)(q);
			S ? l.find("body").append(te) : P ? angular.element(P).eq(0).append(te) : t.after(te),
			this.init = function (t, n) {
				h = t,
				g = n,
				q.debounceUpdate = h.$options && i(h.$options.debounce)(e),
				h.$parsers.unshift(function (t) {
					return k = !0,
					0 === $ || t && t.length >= $ ? y > 0 ? (Q(), J(t)) : K(t) : (x(e, !1), Q(), W()),
					w ? t : t ? void h.$setValidity("editable", !1) : (h.$setValidity("editable", !0), null)
				}),
				h.$formatters.push(function (t) {
					var n,
					a,
					i = {};
					return w || h.$setValidity("editable", !0),
					O ? (i.$model = t, O(e, i)) : (i[V.itemName] = t, n = V.viewMapper(e, i), i[V.itemName] = void 0, a = V.viewMapper(e, i), n !== a ? n : t)
				})
			}
		}
	...
	return {
		...
		link : function (e, t, n, a) {
			...
			function (t, r) {
				return !o && i(t) && n.warn("Unsafe use of typeahead please use ngSanitize"),
				t = r ? ("" + t).replace(new RegExp(a(r), "gi"), "<strong>$&</strong>") : t,
				o || (t = e.trustAsHtml(t)),
				t
			}
		}
...
!function (e, o) {
	...
	function t(e, t, n) {
		...
		return function (e, n, u) {
			...
			u = u || {},
			s = u.expires,
			c = o.isDefined(u.path) ? u.path : i,
			o.isUndefined(n) && (s = "Thu, 01 Jan 1970 00:00:00 GMT", n = ""),
			o.isString(s) && (s = new Date(s)),
			n = encodeURIComponent(e) + "=" + encodeURIComponent(n),
			n = n + (c ? ";path=" + c : "") + (u.domain ? ";domain=" + u.domain : ""),
			n += s ? ";expires=" + s.toUTCString() : "",
			n += u.secure ? ";secure" : "",
			u = n.length + 1,
			4096 < u && t.warn("Cookie '" + e + "' possibly not set or overflowed because it was too large (" + u + " > 4096 bytes)!"),
			r.cookie = n
		}
	}
...
"undefined" != typeof module && "undefined" != typeof exports && module.exports === exports && (module.exports = "ui.router"), function (e, t, r) {
	...
	function s(e, t, r, n) {
		...
		c = [];
		for (var f in s)
			if (s[f] && s[f].params && (a = o(s[f].params), a.length))
				for (var p in a)
					u(c, a[p]) >= 0 || (c.push(a[p]), l[a[p]] = e[a[p]]);
		return J({}, l, t)
	}
	function l(e, t, r) {
		if (!r) {
	...
	function $(e, t) {
		...
		this.study = function (s) {
			...
			function (n, i, o) {
				...
				b = !1;
				if (R(i.$$failure))
					return s(i.$$failure), m;
				i.$$inheritedValues && a(y, p(i.$$inheritedValues, $)),
				J(g, i.$$promises),
				i.$$values ? (b = a(y, p(i.$$values, $)), m.$$inheritedValues = p(i.$$values, $), u()) : (i.$$inheritedValues && (m.$$inheritedValues = p(i.$$inheritedValues, $)), i.then(u, s));
				for (var S = 0, E = d.length; E > S; S += 3)
					n.hasOwnProperty(d[S]) ? u() : l(d[S], d[S + 1], d[S + 2]);
				return m
			}
		},
	...
	function m(e, t, a) {
		...
		function u(a, i) {
			...
			return o = a[2] || a[3],
			c = t.params[o],
			s = e.substring(p, a.index),
			u = i ? a[4] : a[4] || ("*" == a[1] ? ".*" : null),
			u && (l = _.type(u) || n(_.type("string"), {
		...
		h = this.segments = [],
		v = a ? a.params : {},
		$ = this.params = a ? a.params.$$new() : new _.ParamSet,
		d = [];
		this.source = e;
		for (var m, g, y; (s = l.exec(e)) && (m = u(s, !1), !(m.segment.indexOf("?") >= 0)); )
			g = i(m.id, m.type, m.cfg, "path"), f += o(m.segment, g.type.pattern.source, g.squash, g.isOptional), h.push(m.segment), p = l.lastIndex;
		y = e.substring(p);
		var w = y.indexOf("?");
		if (w >= 0) {
			...
			if (y = y.substring(0, w), this.sourcePath = e.substring(0, p + w), b.length > 0)
				for (p = 0; s = c.exec(b); )
					m = u(s, !0), g = i(m.id, m.type, m.cfg, "search"), p = l.lastIndex
		} else
			this.sourcePath = e, this.sourceSearch = "";
		f += o(y) + (t.strict === !1 ? "/?" : "") + "$",
		h.push(y),
		this.regexp = new RegExp(f, t.caseInsensitive ? "i" : r),
		this.prefix = h[0],
		this.$$paramNames = d
	}
	function g(e) {
	...
	function y() {
		...
		this.Param = function (e, n, a, i) {
			...
			function m(e, t, n, a) {
				...
				return i = z(e.replace) ? e.replace : [],
				U(a) && i.push({
					from : a,
					to : r
				}),
			...
			function y() {
				if (!f)
					throw new Error("Injectable functions cannot be called at configuration time");
				var e = f.invoke(a.$$fn);
				if (null !== e && e !== r && !E.type.is(e))
					throw new Error("Default value (" + e + ") for parameter '" + E.id + "' is not an instance of Type (" + E.type.name + ")");
				return e
			}
			function b(e) {
				function t(e) {
			...
			n = c(a, n, i);
			var x = p();
			n = x ? n.$asArray(x, "search" === i) : n,
			"string" !== n.name || x || "path" !== i || a.value !== r || (a.value = "");
			var P = a.value !== r,
			j = $(a, P),
			A = m(a, x, P, j);
			J(this, {
		...
		c.prototype = {
			$$new : function () {
				return n(this, J(new c, {
						$$parent : this
					}))
			},
			$$keys : function () {
				for (var e = [], t = [], r = this, n = o(c.prototype); r; )
					t.push(r), r = r.$$parent;
				return t.reverse(),
				B(t, function (t) {
					B(o(t), function (t) {
			...
			$$validates : function (e) {
				...
				for (n = 0; n < s.length && (a = this[s[n]], i = e[s[n]], i !== r && null !== i || !a.isOptional); n++) {
					if (o = a.type.$normalize(i), !a.type.is(o))
						return !1;
					if (u = a.type.encode(o), t.isString(u) && !a.type.pattern.exec(u))
						return !1
				}
				return !0
			},
	...
	function w(e, n) {
		...
		function u(n, a, i, o, u) {
			...
			return f || v(), {
				...
				href : function (r, a, i) {
					...
					o = o && u.history;
					var s = r.format(a);
					if (i = i || {}, o || null === s || (s = "#" + e.hashPrefix() + s), null !== s && a && a["#"] && (s += "#" + a["#"]), s = p(s, o, i.absolute), !i.absolute || !s)
						return s;
					var l = !o && s ? "/" : "",
					c = n.port();
					return c = 80 === c || 443 === c ? "" : ":" + c,
					[n.protocol(), "://", n.host(), c, l, s].join("")
				}
			}
		}
		var s,
		...
		this.when = function (e, t) {
			var r,
			u = U(t);
			if (U(e) && (e = n.compile(e)), !u && !F(t) && !z(t))
		...
		this.$get = u,
		u.$inject = ["$location", "$rootScope", "$injector", "$browser", "$sniffer"]
	}
	function b(e, a) {
		function i(e) {
		...
		function p(e, t) {
			...
			if (o) {
				if (!t)
					throw new Error("No reference point given for path '" + a + "'");
				t = p(t);
				for (var u = a.split("."), s = 0, l = u.length, c = t; l > s; s++)
					if ("" !== u[s] || 0 !== s) {
						if ("^" !== u[s])
							break;
						if (!c.parent)
							throw new Error("Path '" + a + "' not valid for state '" + t.name + "'");
						c = c.parent
					} else
						c = t;
				u = u.slice(s).join("."),
		...
		function d(t) {
			...
			if (a && !P[a])
				return h(a, t.self);
			for (var i in O)
				F(O[i]) && (t[i] = O[i](t, O.$delegates[i]));
			return P[r] = t,
			!t[A] && t.url && e.when(t.url, ["$match", "$stateParams", function (e, r) {
						x.$current.navigable == t && l(e, r) || x.transitionTo(t, e, {
							inherit : !0,
							location : !1
						})
					}
		...
		function g(e) {
			for (var t = e.split("."), r = x.$current.name.split("."), n = 0, a = t.length; a > n; n++)
				"*" === t[n] && (r[n] = "*");
			return "**" === t[0] && (r = r.slice(u(r, t[1])), r.unshift("**")),
			"**" === t[t.length - 1] && (r.splice(u(r, t[t.length - 2]) + 1, Number.MAX_VALUE), r.push("**")),
			t.length == r.length && r.join("") === t.join("")
		}
		function y(e, t) {
			return U(e) && !R(t) ? O[e] : F(t) && U(e) ? (O[e] && !O.$delegates[e] && (O.$delegates[e] = O[e]), O[e] = t, this) : this
		}
		function w(e, t) {
			return T(e) ? t = e : t.name = e,
			d(t),
			this
		}
		function b(e, a, i, u, f, h, $, d, y) {
			...
			function b(e, r, n, o, s, l) {
				...
				return o && $.push(o),
				a.all($).then(p).then(function (e) {
					return s
				})
			}
			var j = a.reject(new Error("transition superseded")),
			O = a.reject(new Error("transition prevented")),
			k = a.reject(new Error("transition aborted")),
			q = a.reject(new Error("transition failed"));
			return E.locals = {
				resolve : null,
				globals : {
					$stateParams : {}
			...
			x.reload = function (e) {
				return x.transitionTo(x.current, h, {
					reload : e || !0,
					inherit : !1,
					notify : !0
				})
			...
			x.transitionTo = function (t, r, i) {
				...
				if (i.inherit && (r = s(h, r || {}, x.$current, d)), !d.params.$$validates(r))
					return q;
				r = d.params.$$values(r),
				t = d;
				var P = t.path,
				...
				if (i.reload) {
					if (U(i.reload) || T(i.reload)) {
						if (T(i.reload) && !i.reload.name)
							throw new Error("Invalid reload state object");
						var M = i.reload === !0 ? v[0] : p(i.reload);
						if (i.reload && !M)
							throw new Error("No such reload state '" + (U(i.reload) ? i.reload : i.reload.name) + "'");
						for (; C && C === v[k] && C !== M; )
							I = V[k] = C.locals, k++, C = P[k]
					}
				} else
					for (; C && C === v[k] && C.ownParams.$$equals(r, f); )
						I = V[k] = C.locals, k++, C = P[k];
				if (S(t, r, l, f, I, i))
					return m && (r["#"] = m), x.params = r, K(x.params, h), K(c(t.params.$$keys(), h), t.locals.globals.$stateParams), i.location && t.navigable && t.navigable.url && ($.push(t.navigable.url, r, {
							$$avoidResync : !0,
							replace : "replace" === i.location
						}), $.update(!0)), x.transition = null, a.when(x.current);
				if (r = c(t.params.$$keys(), r || {}), m && (r["#"] = m), i.notify && e.$broadcast("$stateChangeStart", t.self, r, l.self, f, i).defaultPrevented)
					return e.$broadcast("$stateChangeCancel", t.self, r, l.self, f), null == x.transition && $.update(), O;
				for (var D = a.when(I), N = k; N < P.length; N++, C = P[N])
					I = V[N] = n(I), D = b(C, r, C === t, D, I, i);
				var F = x.transition = D.then(function () {
						...
						if (x.transition !== F)
							return j;
						for (n = v.length - 1; n >= k; n--)
							o = v[n], o.self.onExit && u.invoke(o.self.onExit, o.self, o.locals.globals), o.locals = null;
						for (n = k; n < P.length; n++)
							a = P[n], a.locals = V[n], a.self.onEnter && u.invoke(a.self.onEnter, a.self, a.locals.globals);
			...
			x.href = function (e, t, n) {
				...
				return i && i.url !== r && null !== i.url ? $.href(i.url, c(a.params.$$keys().concat("#"), t || {}), {
					absolute : n.absolute
				}) : null
			},
			x.get = function (e, t) {
				if (0 === arguments.length)
					return v(o(P), function (e) {
						return P[e].self
					});
		...
		O = {
			parent : function (e) {
				if (R(e.parent) && e.parent)
					return p(e.parent);
				var t = /^(.+)\.[^.]+$/.exec(e.name);
				return t ? p(t[1]) : E
			},
			data : function (e) {
				return e.parent && e.parent.data && (e.data = e.self.data = n(e.parent.data, e.data)),
				e.data
			},
			url : function (e) {
				var t = e.url,
				...
				if (U(t))
					return "^" == t.charAt(0) ? a.compile(t.substring(1), r) : (e.parent.navigable || E).url.concat(t, r);
				if (!t || a.isMatcher(t))
					return t;
			...
			views : function (e) {
				var t = {};
				return B(R(e.views) ? e.views : {
					"" : e
				}, function (r, n) {
					n.indexOf("@") < 0 && (n += "@" + e.parent.name),
					t[n] = r
				}),
				t
			},
		...
		function e(e, t) {
			return {
				load : function (e, r) {
					...
					return r = J(a, r),
					r.view && (n = t.fromConfig(r.view, r.params, r.locals)),
					n
				}
			}
		}
				...
				return function (r, i, s) {
					...
					function c(o) {
						...
						if ((o || g !== v) && !r._willBeDestroyed) {
							c = r.$new(),
							v = e.$current.locals[f],
							c.$emit("$viewContentLoading", f);
							var y = u(c, function (e) {
									m.enter(e, i, function () {
										h && h.$emit("$viewContentAnimationEnded"),
										(t.isDefined(d) && !d || r.$eval(d)) && n(e)
									}),
									l()
								});
							p = y,
							h = c,
							h.$emit("$viewContentLoaded", f),
							h.$eval($)
						}
					}
					var f,
			...
			compile : function (a) {
				...
				return function (a, o, u) {
					...
					if (c) {
						...
						o.html(c.$template ? c.$template : i);
						var f = e(o.contents());
						if (c.$$controller) {
							c.$scope = a,
							c.$element = o;
							var p = t(c.$$controller, c);
							c.$$controllerAs && (a[c.$$controllerAs] = p),
							o.data("$ngControllerController", p),
							o.children().data("$ngControllerController", p)
						}
						f(a)
					}
				}
	...
	function I(e, r) {
		return {
			...
			link : function (n, a, i, o) {
				var u = A(i.uiSref, e.current.name),
				s = {
					state : u.state,
					href : null,
					params : null
				...
				var f = function (r) {
					r && (s.params = t.copy(r)),
					s.href = e.href(u.state, s.params, s.options),
					c && c.$$addStateInfo(u.state, s.params),
					null !== s.href && i.$set(l.attr, s.href)
				};
				u.paramExpr && (n.$watch(u.paramExpr, function (e) {
						e !== s.params && f(e)
					}, !0), s.params = t.copy(n.$eval(u.paramExpr))),
				f(),
				l.clickable && a.bind("click", q(a, e, r, l, function () {
						return s
					}))
			}
		}
		...
		return {
			...
			link : function (r, n, a, i) {
				function o(t) {
					...
					s && s.$$addStateInfo(f.state, f.params),
					f.href && a.$set(u.attr, f.href)
				}
				var u = k(n),
				s = i[1] || i[0],
				l = [a.uiState, a.uiStateParams || null, a.uiStateOpts || null],
				c = "[" + l.map(function (e) {
						return e || "null"
					}).join(", ") + "]",
				f = {
				...
				r.$watch(c, o, !0),
				o(r.$eval(c)),
				u.clickable && n.bind("click", q(n, e, t, u, function () {
						return f
					}))
			}
		}
	...
	function M(e, t, r) {
		return {
			restrict : "A",
			controller : ["$scope", "$element", "$attrs", "$timeout", function (t, n, a, i) {
					function o(t, r, a) {
						var i = e.get(t, O(n)),
						o = u(t, r);
						$.push({
					...
					function s() {
						for (var e = 0; e < $.length; e++)
							f($[e].state, $[e].params) ? l(n, d[$[e].hash]) : c(n, d[$[e].hash]), p($[e].state, $[e].params) ? l(n, h) : c(n, h)
					}
					function l(e, t) {
						i(function () {
							e.addClass(t)
					...
					v = v || r(a.uiSrefActive || "", !1)(t),
					T(v) && B(v, function (r, n) {
						if (U(r)) {
	...
	d.$inject = ["$http", "$templateCache", "$injector"],
	t.module("ui.router.util").service("$templateFactory", d);
	var _;
	m.prototype.concat = function (e, t) {
		var r = {
			caseInsensitive : _.caseInsensitive(),
			strict : _.strictMode(),
			squash : _.defaultSquashPolicy()
		};
	...
	m.prototype.exec = function (e, t) {
		...
		p;
		for (a = 0; l > a; a++) {
			for (o = u[a], f = this.params[o], p = n[a + 1], i = 0; i < f.replace.length; i++)
				f.replace[i].from === p && (p = f.replace[i].to);
			p && f.array === !0 && (p = r(p)),
			R(p) && (p = f.type.decode(p)),
			c[o] = f.value(p)
		}
		for (; s > a; a++) {
			for (o = u[a], c[o] = this.params[o].value(t[o]), f = this.params[o], p = t[o], i = 0; i < f.replace.length; i++)
				f.replace[i].from === p && (p = f.replace[i].to);
			R(p) && (p = f.type.decode(p)),
			c[o] = f.value(p)
		}
	...
	m.prototype.format = function (e) {
		...
		for (i = 0; s > i; i++) {
			...
			if (c) {
				...
				y = i + 1 === u;
				if (d === !1)
					null != m && (l += z(m) ? v(m, t).join("-") : encodeURIComponent(m)), l += g;
				else if (d === !0) {
					var w = l.match(/\/$/) ? /\/?(.*)/ : /(.*)/;
					l += g.match(w)[1]
				} else
				...
				if (null == m || $ && d !== !1)
					continue;
				if (z(m) || (m = [m]), 0 === m.length)
					continue;
				m = v(m, encodeURIComponent).join("&" + f + "="),
				l += (o ? "&" : "?") + (f + "=" + m),
				o = !0
			}
		}
	...
	g.prototype.$asArray = function (e, t) {
		function n(e, t) {
			...
			this.encode = u(n(e, "encode")),
			this.decode = u(n(e, "decode")),
			this.is = u(n(e, "is"), !0),
			this.equals = s(n(e, "equals")),
			this.pattern = e.pattern,
			this.$normalize = u(n(e, "$normalize")),
			this.name = e.name,
			this.$arrayMode = t
		}
		if (!e)
	...
	S.$inject = [],
	t.module("ui.router.state").provider("$view", S),
	t.module("ui.router.state").provider("$uiViewScroll", E);
	var Y = t.version.major,
	G = t.version.minor;
	x.$inject = ["$state", "$injector", "$uiViewScroll", "$interpolate"],
	P.$inject = ["$compile", "$controller", "$state", "$interpolate"],
	t.module("ui.router.state").directive("uiView", x),
	t.module("ui.router.state").directive("uiView", P),
	I.$inject = ["$state", "$timeout"],
	V.$inject = ["$state", "$timeout"],
	M.$inject = ["$state", "$stateParams", "$interpolate"],
	t.module("ui.router.state").directive("uiSref", I).directive("uiSrefActive", M).directive("uiSrefActiveEq", M).directive("uiState", V),
	D.$inject = ["$state"],
	N.$inject = ["$state"],
	t.module("ui.router.state").filter("isState", D).filter("includedByState", N)
}
(window, window.angular);
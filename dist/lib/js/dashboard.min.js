...
function dashboardCtrl($scope, $compile, $http, $state, $rootScope) {
	...
	function createMarkers(records) {
		...
		angular.element(document.getElementById('info-popout')).append($compile("<div>Total Markers: "+count+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Assigned Markers: "+assigned+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Unassigned Markers: "+(count-assigned)+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Groups: "+isgroup+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Individuals: "+(count-isgroup)+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Male: "+gender+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Female: "+(count-gender)+"</div>")($scope));		
	...
	function getContain(records, district){
		...
		angular.element(document.getElementById('info-popout')).append($compile("<div>Region: "+district.name+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Markers by region: "+count+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Assigned Markers: "+assigned+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Unassigned Markers: "+(count-assigned)+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Groups: "+isgroup+"</div>")($scope));		
		angular.element(document.getElementById('info-popout')).append($compile("<div>Individuals: "+(count-isgroup)+"</div>")($scope));		

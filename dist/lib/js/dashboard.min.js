...
function ReferalCtrl($scope, $compile, $http) {
...
angular.module("RDash", ["ui.bootstrap", "ui.router", "ngCookies"]), angular.module("RDash").config(["$stateProvider", "$urlRouterProvider", function (e, t) {
	...
	angular.module("RDash").controller("ChartsCtrl", ["$scope", ChartsCtrl]), 
	angular.module("RDash").controller("dashboardCtrl", ["$scope", "$compile", "$http", dashboardCtrl]),
	angular.module("RDash").controller("ReferalCtrl", ["$scope", "$compile", "$http", ReferalCtrl]),

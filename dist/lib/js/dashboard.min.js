...
function MasterCtrl(e, t) {
    ...
    }, e.$watch(e.getWidth, function(a, r) {
        a >= i ? angular.isDefined(t.get("toggle")) ? e.toggle = !!t.get("toggle") : e.toggle = !0 : e.toggle = !1
    }), e.toggleSidebar = function() {
        e.toggle = !e.toggle, t.put("toggle", e.toggle)

...
function ReferalCtrl($scope, $compile, $http, $timeout) {
	...
	$scope.AssignResp = function(e){
		...
		var id = $scope.refpgLists[e].id;
		console.log($scope.refpgLists[e].name);
		var data = {
			responder: "Arun", 
			idnum: id
...
function dashboardCtrl($scope, $compile, $http, $state) {
	if(getService() == "false"){
    ...
    /*
		  ...
		  Markers.getMarkers().then(function(markers){
			...
			var record = records[i];  
			var markerimg = {
				url: icons[record.icondir.icon].icon,
				scaledSize: new google.maps.Size(44,66), // scaled size
				origin: new google.maps.Point(0,0), // origin
				anchor: new google.maps.Point(22,66) // anchor
			};
...
angular.module("OHAI", ["ui.bootstrap", "ui.router", "ngCookies"]), angular.module("OHAI").config(["$stateProvider", "$urlRouterProvider", function (e, t) {
	...
	angular.module("OHAI").controller("dashboardCtrl", ["$scope", "$compile", "$http", "$state", dashboardCtrl]),
